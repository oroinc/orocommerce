...
class PageFormExtension extends AbstractTypeExtension
{
    /**
     * @var ManagerRegistry
     */
    ...
    public function onPostSubmit(FormEvent $event)
    {
        ...
        $this->persistMetaFields($entityManager, $page->getMetaTitles());
        $this->persistMetaFields($entityManager, $page->getMetaDescriptions());
        $this->persistMetaFields($entityManager, $page->getMetaKeywords());
    }
