...
class ResponseStatusMap
{
    ...
    const BAS_MERCHANT_IS_NOT_ENROLLED_FOR_BUYER_AUTHENTICATION_SERVICE_3_D_SECURE = 1014;
    ...
    protected static $messages = [
        ...
        self::BAS_MERCHANT_IS_NOT_ENROLLED_FOR_BUYER_AUTHENTICATION_SERVICE_3_D_SECURE =>
    ...
    public static function getMessage($code)
    {
        if (!array_key_exists($code, static::$messages)) {
            throw new \InvalidArgumentException('Not supported status message');
        }
