...
class PaymentMethodApplicableTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->addressExtractor->expects($this->any())->method('getCountryIso2')->willReturn('US');

        $this->condition = new PaymentMethodApplicable($this->paymentMethodRegistry, $this->addressExtractor);
    }
