...
use OroB2B\Bundle\CustomerBundle\EventListener\DatagridListener;
    ...
    protected $expectedTemplate = [
        'source' => [
            'query' => [
                ...
                'join' => [
                    'left' => [
                        [
                            'join' => 'OroB2BCustomerBundle:AccountUserRole',
        ...
        'columns' => [
            DatagridListener::ACCOUNT_USER_ROLE_COLUMN => [
                'label' => 'orob2b.customer.accountuserrole.entity_label'
            ],
        ],
        'sorters' => [
            'columns' => [
