...
namespace OroB2B\Bundle\CustomerBundle\Tests\Unit\Datagrid\Extension;

use Symfony\Component\DependencyInjection\ContainerInterface;

use Oro\Bundle\DataGridBundle\Datagrid\Common\DatagridConfiguration;

use OroB2B\Bundle\CustomerBundle\Datagrid\Extension\AccountUserExtension;
...
class AccountUserExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIsApplicable($user, $class, $expected)
    {
        $this->container->expects($this->once())->method('getParameter')
            ->with('orob2b_customer.entity.account_user.class')->willReturn($class);
    ...
    {
        return [
            [null, 'OroB2B\Bundle\CustomerBundle\Entity\AccountUser', false],
            ['anon.', 'OroB2B\Bundle\CustomerBundle\Entity\AccountUser', false],
            [new AccountUser(), 'OroB2B\Bundle\CustomerBundle\Entity\AccountUser', true],
            [
                'OroB2B\Bundle\CustomerBundle\Entity\AccountUser',
                'OroB2B\Bundle\CustomerBundle\Entity\AccountUser',
                true,
            ],
        ];
