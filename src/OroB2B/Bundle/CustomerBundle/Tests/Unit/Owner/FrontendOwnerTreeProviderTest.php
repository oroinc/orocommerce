...
use OroB2B\Bundle\CustomerBundle\Owner\FrontendOwnerTreeProvider;
...
{
    const ACCOUNT_USER_CLASS = 'OroB2B\Bundle\CustomerBundle\Entity\AccountUser';
    ...
    protected function setUp()
    {
        ...
        $this->ownershipMetadataProvider =
            $this->getMockBuilder('OroB2B\Bundle\CustomerBundle\Owner\Metadata\FrontendOwnershipMetadataProvider')
    ...
    protected function getTestData()
    {
        ...
        $firstUser->setCustomer($mainCustomer);
        ...
        $secondUser->setCustomer($secondCustomer);
        ...
        $thirdUser->setCustomer($childCustomer);
