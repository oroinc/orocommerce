...
namespace OroB2B\Bundle\CustomerBundle\Tests\Unit\JsTree;

use Doctrine\Common\Collections\ArrayCollection;

use PHPUnit_Framework_MockObject_MockObject as Mock;

use OroB2B\Bundle\CustomerBundle\JsTree\CustomerTreeHandler;
...
class CustomerTreeHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $customer = $this->getMockBuilder('OroB2B\Bundle\CustomerBundle\Entity\Customer')
            ->disableOriginalConstructor()
            ->getMock();
