...
namespace OroB2B\Bundle\ShoppingListBundle\DependencyInjection\CompilerPass;
...
{
    const REGISTRY_SERVICE = 'orob2b_shopping_list.subtotal_processor.subtotal_provider_registry';
    const TAG = 'orob2b_shopping_list.subtotal_provider';
