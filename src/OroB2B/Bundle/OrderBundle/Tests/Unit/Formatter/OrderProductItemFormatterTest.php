...
class OrderProductItemFormatterTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->formatter    = new OrderProductItemFormatter($this->translator);
    }
    ...
    public function testFormatPriceTypeLabel()
    {
        $this->translator->expects($this->once())
            ->method('trans')
            ->with('orob2b.order.orderproductitem.price_type.test_type')
        ;
    ...
    public function formatPriceTypeLabelsProvider()
    {
        return [
            [
                ...
                'expected' => [
                    1 => 'orob2b.order.orderproductitem.price_type.type_1',
                    2 => 'orob2b.order.orderproductitem.price_type.type_2'
                ],
            ]
        ];
    }
