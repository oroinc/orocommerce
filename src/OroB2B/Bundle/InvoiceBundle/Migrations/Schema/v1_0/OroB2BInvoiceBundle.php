...
namespace OroB2B\Bundle\InvoiceBundle\Migrations\Schema\v1_0;
 ...
 */
class OroB2BInvoiceBundle implements Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function createOrob2BInvoiceLineItemTable(Schema $schema)
    {
        ...
        $table->addColumn('price_type', 'integer', ['unsigned' => true]);
        $table->setPrimaryKey(['id']);
    }
