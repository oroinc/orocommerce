...
use OroB2B\Bundle\CheckoutBundle\Layout\DataProvider\LineItemsWithTotalsDataProvider;
use OroB2B\Bundle\PricingBundle\SubtotalProcessor\Provider\LineItemSubtotalProvider;
use OroB2B\Bundle\ProductBundle\Tests\Unit\Entity\Stub\Product;
use OroB2B\Bundle\OrderBundle\Entity\OrderLineItem;

class LineItemsWithTotalsDataProviderTest extends \PHPUnit_Framework_TestCase
{
    use EntityTrait;
    ...
    /**
     * @var LineItemsWithTotalsDataProvider
     */
    protected $provider;
    ...
    public function setUp()
    {
        ...
        $this->provider = new LineItemsWithTotalsDataProvider(
