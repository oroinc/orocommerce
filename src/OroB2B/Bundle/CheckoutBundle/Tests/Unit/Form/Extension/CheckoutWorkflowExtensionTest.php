...
namespace OroB2B\Bundle\CheckoutBundle\Tests\Unit\Form\Extension;
...
use OroB2B\Bundle\CheckoutBundle\Form\Extension\CheckoutWorkflowExtension;
...
class CheckoutWorkflowExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function finishViewProvider()
    {
        ...
        $orderChangedError = new FormError('orob2b.checkout.workflow.condition.content_of_order_was_changed.message');
        ...
        return [
            ...
            'workflow related error' => [
                ...
                'expectedMessages' => [
                    'warning' => ['orob2b.checkout.workflow.condition.content_of_order_was_changed.message'],
                ],
            ],
            'nested errors' => [
                'passedFormErrors' => [
