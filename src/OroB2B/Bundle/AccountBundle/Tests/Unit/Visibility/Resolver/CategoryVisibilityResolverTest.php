...
class CategoryVisibilityResolverTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetCategoryVisibilitiesForAccountGroups()
    {
        ...
        /** @var AccountGroup $accountGroup */
        $accountGroups = [
            $this->getEntity('OroB2B\Bundle\AccountBundle\Entity\AccountGroup', ['id' => 1]),
            $this->getEntity('OroB2B\Bundle\AccountBundle\Entity\AccountGroup', ['id' => 2]),
        ];
        ...
        $categoryVisibilityResolvedRepository->expects($this->once())
            ->method('getCategoryVisibilitiesForAccountGroups')
            ->with($category, $accountGroups, BaseCategoryVisibilityResolved::VISIBILITY_VISIBLE)
            ->willReturn($expectedVisibilities);
        ...
        $this->assertEquals(
            $expectedVisibilities,
            $this->resolver->getCategoryVisibilitiesForAccountGroups($category, $accountGroups)
        );
    }
    ...
    public function testGetCategoryVisibilitiesForAccounts()
    {
        ...
        /** @var Account $account */
        $accounts = [
            $this->getEntity('OroB2B\Bundle\AccountBundle\Entity\Account', ['id' => 1]),
            $this->getEntity('OroB2B\Bundle\AccountBundle\Entity\Account', ['id' => 2]),
        ];
        ...
        $categoryVisibilityResolvedRepository->expects($this->once())
            ->method('getCategoryVisibilitiesForAccounts')
            ->with($category, $accounts, BaseCategoryVisibilityResolved::VISIBILITY_VISIBLE)
            ->willReturn($expectedVisibilities);
        ...
        $this->assertEquals(
            $expectedVisibilities,
            $this->resolver->getCategoryVisibilitiesForAccounts($category, $accounts)
        );
    }
