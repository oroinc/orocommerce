    ...
    public function onSuccessDataProvider()
    {
        ...
        return [
            ...
            'clone system role and add one user'  => [
                ...
                'newRole'                  => clone $role,
                'appendUsers'              => [],
                'removeUsers'              => [$assignedUsers[2]],
                'assignedUsers'            => $assignedUsers,
                'accountUser'              => $accountUser,
                'expectedUsers'            => [$assignedUsers[1]],
                'expectedUsersWithoutRole' => [$assignedUsers[2], $assignedUsers[1]],
            ],
            'change customizable role'            => [
                'role'                     => $roleWithAccount,
                'newRole'                  => $roleWithAccount,
                'appendUsers'              => [$usersForUpdateRole[3]],
                'removeUsers'              => [$usersForUpdateRole[1]],
                'assignedUsers'            => [$usersForUpdateRole[1], $usersForUpdateRole[2]],
                'accountUser'              => $accountUser,
                'expectedUsers'            => [$usersForUpdateRole[3]],
                'expectedUsersWithoutRole' => [$usersForUpdateRole[1]],
            ],
            'create role'            => [
                'role'                     => $roleWithAccount,
                'newRole'                  => $roleWithAccount,
