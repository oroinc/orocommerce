...
class QuoteProductRequestTypeTest extends AbstractTest
{
    ...
    protected function setUp()
    {
        ...
        $this->formType = new QuoteProductRequestType($translator);
    }
    ...
    public function submitProvider()
    {
        return [
            'empty price' => [
                ...
                'expectedData'  => $this->getQuoteProductRequest(10, 'kg'),
            ],
            'valid data' => [
                'isValid'       => true,
                'submittedData' => [
                ...
                'expectedData'  => $this->getQuoteProductRequest(10, 'kg', Price::create(20, 'USD')),
            ],
        ];
    }
