...
class CategoryControllerTest extends WebTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->loadFixtures(['OroB2B\Bundle\CatalogBundle\Tests\Functional\DataFixtures\LoadLocaleData']);
    ...
    {
        return $this->assertCreate(self::DEFAULT_CATEGORY_TITLE);
    }
     ...
     * @return int
     */
    protected function assertCreate($title, $parentId = self::MASTER_CATALOG_ID)
    {
