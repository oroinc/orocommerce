...
namespace OroB2B\Bundle\CustomerAdminBundle\Tests\Unit\Autocomplete;
...
use OroB2B\Bundle\CustomerAdminBundle\Autocomplete\ParentCustomerSearchHandler;
...
class ParentCustomerSearchHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        $this->entityRepository = $this
            ->getMockBuilder('OroB2B\Bundle\CustomerAdminBundle\Entity\Repository\CustomerRepository')
