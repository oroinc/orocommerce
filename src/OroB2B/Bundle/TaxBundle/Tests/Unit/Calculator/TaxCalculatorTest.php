...
class TaxCalculatorTest extends AbstractTaxCalculatorTest
{
    ...
    public function calculateDataProvider()
    {
        return [
            ...
            'Fremont County' => [['61.9920', '59.04', '2.9520', '0.0020'], '59.04', '0.05'],
            'Tulare County' => [['15.5628', '14.41', '1.1528', '0.0028'], '14.41', '0.08'],
            'Mclean County' => [['38.122500', '35.88', '2.242500', '0.0025'], '35.88', '0.0625'],

            // edge cases
            [['31.96', '15.98', '15.98', '0'], '15.98', '1'],
            [['47.94', '15.98', '31.96', '0'], '15.98', '2'],
            [['31.8002', '15.98', '15.8202', '0.0002'], '15.98', '0.99'],
            [['15.99598', '15.98', '0.01598', '-0.00402'], '15.98', '0.001'],
            [['16.003970', '15.98', '0.023970', '0.003970'], '15.98', '0.0015'],
