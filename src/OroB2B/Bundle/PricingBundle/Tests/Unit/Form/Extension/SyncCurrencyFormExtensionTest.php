...
use OroB2B\Bundle\PricingBundle\Form\Extension\SyncCurrencyFormExtension;

class SyncCurrencyFormExtensionTest extends FormIntegrationTestCase
{
    /**
    ...
    protected function getExtensions()
    {
        return [
            new PreloadedExtension(
                ...
                [
                    'form' => [new SyncCurrencyFormExtension(
                        $this->configManager,
                        $this->localeSettings,
                        $this->translator
                    )],
    ...
    public function testSubmitForm(
        ...
        $rootForm->expects($this->any())
            ->method('has')
            ->with(SyncCurrencyFormExtension::ENABLED_CURRENCIES_NAME)
            ->willReturn(true);
        ...
        $rootForm->expects($this->any())
            ->method('get')
            ->willReturnMap([
                [SyncCurrencyFormExtension::DEFAULT_CURRENCY_NAME, $defaultCurrenciesForm],
                [SyncCurrencyFormExtension::ENABLED_CURRENCIES_NAME, $enabledCurrenciesForm]
            ]);
