...
class CategoryVisibilityQueryBuilderModifier
{
    ...
    public function restrictForAnonymous(QueryBuilder $queryBuilder, OrganizationInterface $organization): void
    {
    ...
    private function getAnonymousCustomerGroupScope(OrganizationInterface $organization): Scope
    {
