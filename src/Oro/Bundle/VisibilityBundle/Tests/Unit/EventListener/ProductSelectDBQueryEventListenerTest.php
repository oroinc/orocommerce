...
use Oro\Bundle\VisibilityBundle\EventListener\ProductSelectDBQueryEventListener;
...
class ProductSelectDBQueryEventListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->modifier = $this
            ->getMockBuilder('Oro\Bundle\VisibilityBundle\Model\ProductVisibilityQueryBuilderModifier')
            ->disableOriginalConstructor()->getMock();
