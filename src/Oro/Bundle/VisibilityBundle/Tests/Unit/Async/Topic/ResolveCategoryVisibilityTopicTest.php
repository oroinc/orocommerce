...
class ResolveCategoryVisibilityTopicTest extends AbstractTopicTestCase
{
    protected function getTopic(): TopicInterface
    {
        ...
        $managerRegistry
            ...
            ->willReturnCallback(function (string $class) {
                return is_a($class, VisibilityInterface::class, true) || is_a($class, Category::class, true)
                    ? $this->createMock(EntityManagerInterface::class)
                    : null;
            });

        return new ResolveCategoryVisibilityTopic($managerRegistry);
    }
    ...
    public function validBodyDataProvider(): array
    {
        return [
            'required only' => [
                ...
                'expectedBody' => ['entity_class_name' => CategoryVisibility::class, 'id' => 42],
            ],
    ...
    public function invalidBodyDataProvider(): array
    {
        return [
            ...
            'with target_class_name, without target_id' => [
                'body' => ['entity_class_name' => CategoryVisibility::class, 'target_class_name' => Category::class],
                'exceptionClass' => InvalidOptionsException::class,
