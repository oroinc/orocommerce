...
/**
 * @ORM\Entity(
 *   repositoryClass="Oro\Bundle\VisibilityBundle\Entity\Visibility\Repository\CustomerGroupCategoryVisibilityRepository"
 * )
 * @ORM\Table(
 *      name="oro_cus_grp_ctgr_visibility",
 *      uniqueConstraints={
 *          @ORM\UniqueConstraint(
 *              name="oro_cus_grp_ctgr_vis_uidx",
