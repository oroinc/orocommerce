...
/**
* Entity that represents Customer Group Category Visibility
*
*/
#[ORM\Entity(repositoryClass: CustomerGroupCategoryVisibilityRepository::class)]
#[ORM\Table(name: 'oro_cus_grp_ctgr_visibility')]
#[ORM\UniqueConstraint(name: 'oro_cus_grp_ctgr_vis_uidx', columns: ['category_id', 'scope_id'])]
#[Config]
class CustomerGroupCategoryVisibility implements VisibilityInterface, ScopeAwareInterface
{
    public const PARENT_CATEGORY = 'parent_category';
    public const CATEGORY = 'category';
    public const VISIBILITY_TYPE = 'customer_group_category_visibility';
