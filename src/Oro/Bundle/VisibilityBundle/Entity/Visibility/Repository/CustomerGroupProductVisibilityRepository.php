...
/**
 * Repository for {@see CustomerGroupProductVisibility} entities.
 *
 * Provides specialized query methods for managing product visibility settings at the customer group level,
