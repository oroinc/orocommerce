...
namespace Oro\Bundle\VisibilityBundle\Migrations\Schema\v1_7;
...
class OroAccountBundle implements Migration, RenameExtensionAwareInterface
{
    ...
    private function renameActivityTables(Schema $schema, QueryBag $queries)
    {
        ...
        $queries->addQuery(new UpdateExtendRelationQuery(
            ...
            'Oro\Bundle\VisibilityBundle\Entity\AccountUser',
    ...
    private function updateAttachments(Schema $schema, QueryBag $queries)
    {
        ...
        $queries->addQuery(new UpdateExtendRelationQuery(
            ...
            'Oro\Bundle\VisibilityBundle\Entity\Account',
            'account_557018f',
            'account_8d93c122',
    ...
    private function updateNotes(Schema $schema, QueryBag $queries)
    {
        ...
        $queries->addQuery(new UpdateExtendRelationQuery(
            'Oro\Bundle\NoteBundle\Entity\Note',
            'Oro\Bundle\VisibilityBundle\Entity\AccountUserRole',
        ...
        $queries->addQuery(new UpdateExtendRelationQuery(
            'Oro\Bundle\NoteBundle\Entity\Note',
            'Oro\Bundle\VisibilityBundle\Entity\AccountGroup',
