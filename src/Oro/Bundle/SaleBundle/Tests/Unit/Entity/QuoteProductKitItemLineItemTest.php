 ...
 */
class QuoteProductKitItemLineItemTest extends TestCase
{
    ...
    public function testProperties(): void
    {
        $properties = [
            ...
            ['lineItem', new BaseQuoteProductItem()],
        ...
        self::assertPropertyAccessors(new QuoteProductKitItemLineItem(), $properties);
    }
    ...
    {
        $product = new Product();
        $kitItemLineItem = (new QuoteProductKitItemLineItem())->setProduct($product);
    ...
    {
        $kitItem = new ProductKitItemStub();
        $kitItemLineItem = (new QuoteProductKitItemLineItem())->setKitItem($kitItem);
    ...
    {
        self::assertNull((new QuoteProductKitItemLineItem())->getParentProduct());
    }

    public function testPrice(): void
    {
        $entity = new QuoteProductKitItemLineItem();
