...
namespace Oro\Bundle\SaleBundle\Tests\Unit\ProductKit\Factory;
...
class QuoteProductKitItemLineItemFactoryTest extends TestCase
{
    private ProductKitItemProductsProvider|MockObject $kitItemProductsProvider;

    private QuoteProductKitItemLineItemFactory $factory;

    protected function setUp(): void
    {
        $this->kitItemProductsProvider = $this->createMock(ProductKitItemProductsProvider::class);

        $this->factory = new QuoteProductKitItemLineItemFactory($this->kitItemProductsProvider);
    }
    ...
    public function testCreateKitItemLineItemWhenOptional(
        ...
        ?float $quantity,
        QuoteProductKitItemLineItem $expected
    ): void {
    ...
    public function createKitItemLineItemWhenOptionalDataProvider(): array
    {
        ...
        return [
            'no explicit arguments' => [
                ...
                'productUnit' => null,
                'quantity' => null,
                'expected' => new QuoteProductKitItemLineItem(),
            ],
