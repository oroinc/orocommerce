...
use Oro\Bundle\SaleBundle\Form\EventListener\QuoteProductKitItemLineItemGhostOptionListener;
use Oro\Bundle\SaleBundle\Tests\Unit\Stub\QuoteProductKitItemLineItemStub;
...
class QuoteProductKitItemLineItemGhostOptionListenerTest extends TestCase
{
    private QuoteProductKitItemLineItemGhostOptionListener $listener;
    ...
    public function testOnPreSetDataWhenKitItemLineItemIsNew(): void
    {
        ...
        $formBuilder = $this->formFactory->createBuilder(FormType::class, new QuoteProductKitItemLineItem())
            ->add('product', FormTypeStub::class, ['choices' => [$product1, $product2]])
            ->addEventSubscriber($this->listener);
    ...
    public function testOnPreSetDataWhenProductPresent(): void
    {
        ...
        $kitItemLineItem = (new QuoteProductKitItemLineItemStub(42))
            ->setProduct($product1);
