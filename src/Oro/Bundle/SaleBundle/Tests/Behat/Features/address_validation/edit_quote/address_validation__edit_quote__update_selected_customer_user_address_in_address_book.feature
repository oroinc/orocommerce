...
Feature: Address Validation - Edit Quote - Update Selected Customer User Address In Address Book
  As an Administrator
  ...
  Scenario: Update selected customer user address with suggested
    ...
    Then I should not see "ORO, 2849 Junkins Avenue, ALBANY NY US 31707"
