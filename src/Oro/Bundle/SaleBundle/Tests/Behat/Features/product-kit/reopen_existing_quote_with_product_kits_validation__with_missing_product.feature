...
@fixture-OroSaleBundle:product-kit/reopen_existing_quote_with_product_kits_validation__with_missing_product__quote.yml

Feature: Reopen Existing Quote with Product Kits Validation - with Missing Product
  ...
  Scenario: Reopen the Quote, Redirect to new Quote, Internal status: Draft
    When I click "Reopen"
