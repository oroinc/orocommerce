...
@fixture-OroSaleBundle:product-kit/clone_existing_quote_with_product_kits_validation__with_missing_product__quote.yml

Feature: Clone existing Quote with Product Kits Validation - with Missing Product
  ...
  Scenario: Clone, Redirect to new Quote, Internal status: Draft
    When I click "Clone"
