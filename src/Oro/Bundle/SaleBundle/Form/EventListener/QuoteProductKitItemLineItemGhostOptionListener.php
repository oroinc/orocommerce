 ...
 */
class QuoteProductKitItemLineItemGhostOptionListener implements EventSubscriberInterface
{
    ...
    public function onPreSetData(FormEvent $event): void
    {
        ...
        FormUtils::replaceField(
            ...
            [
                'data' => $product,
                'setter' => function (QuoteProductKitItemLineItem $kitItemLineItem, ?Product $product) {
