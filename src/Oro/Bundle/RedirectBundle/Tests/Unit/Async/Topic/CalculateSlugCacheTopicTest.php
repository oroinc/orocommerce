...
class CalculateSlugCacheTopicTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testConfigureMessageBody(): void
    {
        ...
        self::assertContains(CalculateSlugCacheTopic::JOB_ID, $resolver->getDefinedOptions());
        self::assertEquals(
            ['int'],
            $optionsResolverIntrospector->getAllowedTypes(CalculateSlugCacheTopic::JOB_ID)
        );
    }
}
