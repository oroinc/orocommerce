...
class ProductKitItemType extends AbstractType
{
    ...
    public function setUnitFieldsSettings(ProductUnitFieldsSettingsInterface $unitFieldsSettings): void
    {
        $this->unitFieldsSettings = $unitFieldsSettings;
    }
    ...
    public function onPreSetData(FormEvent $event): void
    {
        ...
        $choices = $data?->getProductKit() ?
            $this->unitFieldsSettings->getAvailablePrimaryUnitChoices($data?->getProductKit()) :
            $this->unitFieldsSettings->getAvailablePrimaryUnitChoices();
