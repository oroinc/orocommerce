...
/**
 * Modifies the query that is used to retrive related product to be deleted
 * to return only relations for which both products in relation are accessible by an user,
 * and adds an additional ACL check for VIEW permission for the query (this is required
 * because of Delete action sets ACL before the query is modified).
 */
