...
class ConfigurationTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testDefaultImportExportCategoryConfiguration(): void
    {
        ...
        self::assertTrue($processedConfig['settings'][Configuration::EXPORT_CATEGORY_PATH]['value']);
        self::assertFalse($processedConfig['settings'][Configuration::EXPORT_CATEGORY_DEFAULT_TITLE]['value']);
        self::assertEquals(
