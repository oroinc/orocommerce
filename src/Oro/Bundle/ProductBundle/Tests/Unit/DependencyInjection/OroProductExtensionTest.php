            ...
            [
                [
                    'settings' => [
                        ...
                        'related_products_max_items' => ['value' => 5, 'scope' => 'app'],
                        ...
                        'upsell_products_max_items' => ['value' => 5, 'scope' => 'app'],
                        ...
                        Configuration::IMPORT_CATEGORY_NON_UNIQUE_RESOLUTION => [
                            'value' => Configuration::IMPORT_CATEGORY_NON_UNIQUE_RESOLUTION_FAIL,
                            'scope' => 'app'
                        ],
                        Configuration::IMPORT_CATEGORY_MISMATCH_RESOLUTION => [
                            'value' => Configuration::IMPORT_CATEGORY_MISMATCH_RESOLUTION_FAIL,
                            'scope' => 'app'
                        ],
                    ]
                ]
