...
class FrontendProductGridEventListenerTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->listener->setProductRepository($this->productRepository);
        $this->listener->setDatagridManagerLink($datagridManagerLink);
        $this->listener->setFiltersStateProvider($this->filtersStateProvider);
        $this->listener->setSortersStateProvider($this->sortersStateProvider);
