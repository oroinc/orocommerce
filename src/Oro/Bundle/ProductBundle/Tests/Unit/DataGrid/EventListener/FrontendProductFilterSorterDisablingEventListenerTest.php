...
class FrontendProductFilterSorterDisablingEventListenerTest extends \PHPUnit_Framework_TestCase
{
    use EntityTrait;
    ...
    public function testOnSearchResultBeforeSameQueries()
    {
        ...
        /** @var AttributeFamilyRepository|\PHPUnit_Framework_MockObject_MockObject $attributeFamilyRepository */
