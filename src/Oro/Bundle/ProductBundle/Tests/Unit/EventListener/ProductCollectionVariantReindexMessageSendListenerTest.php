...
class ProductCollectionVariantReindexMessageSendListenerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testScheduleMessageBySegmentDefinition()
    {
        ...
        $message = [
            ...
            AccumulateSegmentMessageFactory::ID => 42,
        ...
        $this->collectionIndexationHandler
            ...
            ->with(
                $scheduledPartialMessages,
                'oro_product.accumulate_reindex_product_collection_by_segment:listener:433143095836f9cab5eb7d9c9374cab5'
            );
    ...
    public function testScheduleSegment()
    {
        ...
        $this->collectionIndexationHandler
            ...
            ->with(
                $scheduledPartialMessages,
                'oro_product.accumulate_reindex_product_collection_by_segment:listener:823a241bbe36fd0f41c4b4dd1f838185'
            );
