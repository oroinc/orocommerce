...
class DatagridKitItemLineItemsDataEventTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->event = new DatagridKitItemLineItemsDataEvent(
            [
    ...
    {
        self::assertEquals(
            DatagridKitItemLineItemsDataEvent::NAME . '.test-grid',
            $this->event->getName()
        );
    }
}
