...
Feature: Simultaneously import extended and serialized fields
  ...
  Scenario: Update schema button appears when importing text and boolean fields from csv
    ...
    Given I fill template with data:
      ...
      | field_text_pf1     | text     | field_text_pf1     | description_value  | oro.marketinglist.entity_config.choices.email | yes             |               |                         | header_value        | 5                  | no                    | no                    |                      | yes                  | yes                  | exact_value         | no                 | yes               | yes               | yes                         | 1                   | yes                  | 20             | yes                 | 10            | yes               | no                  |
