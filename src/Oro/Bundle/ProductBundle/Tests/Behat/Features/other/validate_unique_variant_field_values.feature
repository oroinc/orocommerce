...
Feature: Validate unique variant field values when changing simple products
  ...
  Scenario: Prepare product attributes
    ...
    And set Attribute Groups with:
      ...
      | T-shirt group | true    | [SKU, Name, Is Featured, Description, Short Description, Images, Inventory Status, Meta title, Meta description, Meta keywords, Product prices, Color, Size] |
    And I save form
