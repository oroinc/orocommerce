...
Feature: Validate unique variant field values when changing simple products
  ...
  Scenario: Prepare product attributes
    ...
    And set Attribute Groups with:
      ...
      | T-shirt group | true    | [SKU, Name, Is Featured, New Arrival, Description, Short Description, Images, Inventory Status, Meta description, Meta keywords, Product prices, Color, Size] |
    And I save form
