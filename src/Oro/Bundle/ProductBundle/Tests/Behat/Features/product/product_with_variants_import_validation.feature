...
Feature: Product with variants import validation
  ...
  Scenario: Validate imported file with only configurable products
    ...
    Then I should see oro:import_validation:oro_product_product.add_or_replace:entity_import_validation_from_csv:1 in grid with following data:
      | Status | Success |
