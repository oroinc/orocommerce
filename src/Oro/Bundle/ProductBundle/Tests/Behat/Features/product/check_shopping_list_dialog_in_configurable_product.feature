...
Feature: Check shopping list dialog in configurable product
  ...
  Scenario: Prepare product attributes
    ...
    And set Attribute Groups with:
      ...
      | Attribute group | true    | [SKU, Name, Is Featured, New Arrival, Brand, Description, Short Description, Images, Inventory Status, Meta title, Meta description, Meta keywords, Product prices, Size] |
    And I save form
