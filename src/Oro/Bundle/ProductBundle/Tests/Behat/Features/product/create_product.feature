...
Feature: Create product
  ...
  Scenario: Finalizing product creation
    ...
    When fill "Create Product Form" with:
      | Description | Sample content <img alt=\"cat1_wysiwyg_image\" src=\"{{ wysiwyg_image(42, 'f23ac0ff-2cc0-4d9e-8d00-78053a569a50') }}\"/><a title=\"cat1_wysiwyg_file\" href=\"{{ wysiwyg_file(42, '902dfb57-57c0-4a2f-88bf-adf365d74895') }}\">File of cat1</a> |
    And I save form
  ...
  Scenario: Add another image to description
    ...
    When fill "Product Form" with:
      | Description | Sample content <img alt=\"cat1_wysiwyg_image\" src=\"{{ wysiwyg_image(42, 'f23ac0ff-2cc0-4d9e-8d00-78053a569a50') }}\"/><a title=\"cat1_wysiwyg_file\" href=\"{{ wysiwyg_file(42, '902dfb57-57c0-4a2f-88bf-adf365d74895') }}\">File of cat1</a> Another image: <img alt=\"cat2_wysiwyg_image\" src=\"{{ wysiwyg_image(14, 'c840eec3-4b10-4682-b5cd-4d51fe008b6f') }}\"/> |
    And I save form
