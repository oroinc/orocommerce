...
Feature: Product attributes import with incorrect configuration
  ...
  Scenario: Import Product Attributes as "Serialized fields"
    Given I fill template with data:
      ...
      | DateTimeField | datetime | DateTimeField | description_value  | yes             | header_value1       | 19                 | no                    | no                    | mimetypes_value      | yes                  | yes                  | exact_value         | yes                | yes               | yes               | yes                         | 0                   | no                   | 9              | yes                 | 7             | yes               |
      | TextField     | text     | TextField     | description_value  | yes             | header_value2       | 5                  | no                    | no                    | mimetypes_value      | yes                  | yes                  | exact_value         | yes                | yes               | yes               | yes                         | 0                   | no                   | 20             | yes                 | 10            | yes               |
    When I import file
