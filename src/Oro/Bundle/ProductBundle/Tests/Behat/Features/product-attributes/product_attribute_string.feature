...
Feature: Product attribute string
  ...
  Scenario: Check product grid search for not searchable attribute
    ...
    When I type "TestDaTa" in "search"
    And I click "Search Button"
    Then I should not see "SKU123" and continue checking the condition is met for maximum 30 seconds
    And I should not see "SKU456" product
  ...
  Scenario: Check that attribute is not present
    ...
    Then I should not see "StringField"
    And I should not see "TestDaTa"
