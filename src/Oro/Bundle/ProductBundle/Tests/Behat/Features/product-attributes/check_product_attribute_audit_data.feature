...
Feature: Check product attribute audit data
  ...
  Scenario: Check grid of attribute audit
    ...
    Then I should see following "Product Attribute Audit Grid" grid:
      | Diffs                                                                                                                                                                                                                                  |
      | Contact information: State: New Is serialized: 1 Is attribute: 1 Is global: 0 Field name: StringAttribute Organization id: 1 Search boost: Is visible: 3 Show filter: 0 Order: Priority: Searchable: 0 Title field: 0 Order: Identity: 0 Excluded: 0 |
