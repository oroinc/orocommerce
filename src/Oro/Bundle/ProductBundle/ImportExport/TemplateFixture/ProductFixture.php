...
class ProductFixture extends AbstractTemplateRepository implements TemplateFixtureInterface
{
    ...
    private ProductTypeProvider $typeProvider;
    ...
    public function setTypeProvider(ProductTypeProvider $typeProvider): void
    {
    ...
    public function getData(): iterable
    {
        ...
        $types = array_values($this->typeProvider->getAvailableProductTypes());

        return new \ArrayIterator(
            array_filter($products, static fn ($product) => in_array($product->getType(), $types, true))
        );
    }
