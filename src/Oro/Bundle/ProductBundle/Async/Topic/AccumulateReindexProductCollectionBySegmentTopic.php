 ...
 */
class AccumulateReindexProductCollectionBySegmentTopic extends AbstractTopic
{
    public const NAME = 'oro_product.accumulate_reindex_product_collection_by_segment';
