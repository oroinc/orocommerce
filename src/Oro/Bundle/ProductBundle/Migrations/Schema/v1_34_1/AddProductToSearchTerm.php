...
namespace Oro\Bundle\ProductBundle\Migrations\Schema\v1_34_1;
...
/**
 * Adds the column for SearchTerm::$redirectProduct field
 */
class AddProductToSearchTerm implements Migration, ExtendExtensionAwareInterface
{
