...
import InclusionExclusionSubComponent
    from 'oroproduct/js/app/components/product-collection-inclusion-exclusion-subcomponent';
import SelectedProductGridSubComponent
    from 'oroproduct/js/app/components/product-collection-selected-product-grid-subcomponent';
...
export default ProductCollectionApplyQueryComponent;
