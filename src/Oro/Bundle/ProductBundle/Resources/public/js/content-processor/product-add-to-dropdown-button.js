import $ from 'oroui/js/content-processor/pinned-dropdown-button';
import _ from 'underscore';
import componentContainerMixin from 'oroui/js/app/components/base/component-container-mixin';
import BUTTONS_ORDER from 'oroproduct/js/app/buttons-order';
