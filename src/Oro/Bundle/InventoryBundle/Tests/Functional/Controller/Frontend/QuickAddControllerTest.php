...
class QuickAddControllerTest extends WebTestCase
{
     ...
     * @param int $errorLimit
     *
     * @dataProvider getQuickAddDataWhenIsOptimized
     */
    ...
    public function getQuickAddDataWhenIsOptimized(): array
    {
        return [
    ...
    public function testRFQExcludesQuantityLimitValidationWhenIsOptimized(): void
    {
        self::getConfigManager()->set(
            Configuration::getConfigKeyByName(Configuration::ENABLE_QUICK_ORDER_FORM_OPTIMIZED),
            true
