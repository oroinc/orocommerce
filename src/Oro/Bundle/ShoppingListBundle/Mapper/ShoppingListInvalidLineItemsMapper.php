...
class ShoppingListInvalidLineItemsMapper
{
    ...
    public function mapViolationListBySeverity(
        ...
        foreach ($groupedViolations as $violationsGroup) {
            foreach ($violationsGroup as $violation) {
                ...
                if ($lineItem instanceof ProductKitItemLineItem) {
    ...
    ): null|LineItem|ProductKitItemLineItem {
        $invalidValue = $violation->getInvalidValue();
        if ($invalidValue instanceof LineItem || $invalidValue instanceof ProductKitItemLineItem) {
    ...
    private function getParentLineItemId(LineItem|ProductKitItemLineItem $lineItem): ?int
    {
        return $lineItem instanceof LineItem ? $lineItem->getId() : $lineItem->getLineItem()?->getId();
    }
}
