...
class ProductKitLineItemType extends AbstractType
{
    ...
    public function __construct(
        ...
        $this->lineItemsHolderFactory = new ProductLineItemsHolderFactory();
        $this->lineItemNotPricedSubtotalProvider = $lineItemNotPricedSubtotalProvider;
    }

    public function setLineItemsHolderFactory(ProductLineItemsHolderFactoryInterface $lineItemsHolderFactory): void
    {
