...
/**
 * Event executed before assign shopping list to Customer user in GuestShoppingListMigrationManager
 */
class ShoppingListPreMoveEvent extends ShoppingListEvent
{
    public const string NAME = 'oro_shopping_list.pre_move';
