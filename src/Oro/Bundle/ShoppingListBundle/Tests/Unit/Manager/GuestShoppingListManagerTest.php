...
class GuestShoppingListManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->guestShoppingListManager->setTokenStorage($this->tokenStorage);
        $this->guestShoppingListManager->setWebsiteManager($this->websiteManager);
        $this->guestShoppingListManager->setTranslator($this->translator);
        ...
        $this->guestShoppingListManager->setConfigManager($this->configManager);
    }
