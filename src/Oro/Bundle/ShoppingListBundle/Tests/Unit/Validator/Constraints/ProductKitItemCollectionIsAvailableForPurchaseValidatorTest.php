...
class ProductKitItemCollectionIsAvailableForPurchaseValidatorTest extends ConstraintValidatorTestCase
{
    ...
    {
        $validator = new ProductKitItemCollectionIsAvailableForPurchaseValidator($this->localizationHelper);
        $validator->setTranslationMessageSanitizer($this->translationMessageSanitizer);
    ...
    public function testValidateWhenNotEmptyCollectionAndHasViolationsButIsOptionalAndNoSanitizer(): void
    {
        $constraint = new ProductKitItemCollectionIsAvailableForPurchase();
        $kitItem1 = (new ProductKitItem())
            ->setOptional(true);
        ...
        $this->validator->setTranslationMessageSanitizer(null);
        $this->validator->validate($value, $constraint);

        $this->assertNoViolation();
    }

    public function testValidateWhenNotEmptyCollectionAndHasViolationsAndIsNotOptionalAndNoSanitizer(): void
    {
        $constraint = new ProductKitItemCollectionIsAvailableForPurchase();
        $kitItemLabel = 'Sample Kit Item';
        $kitItem1 = (new ProductKitItem())
