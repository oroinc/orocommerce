...
class DatagridLineItemsDataValidationListenerTest extends TestCase
{
    ...
    public function testOnLineItemDataWhenHasViolations(): void
    {
        ...
        $event = new DatagridLineItemsDataEvent(
            ...
            [
                $lineItem1->getId() => [
                    DatagridLineItemsDataValidationListener::ERRORS => ['existing_error1'],
                    DatagridLineItemsDataValidationListener::WARNINGS => ['existing_warning1'],
                ],
            ],
        ...
        self::assertEquals(
            [
                DatagridLineItemsDataValidationListener::WARNINGS => ['existing_warning1', 'warning1'],
                DatagridLineItemsDataValidationListener::ERRORS => ['existing_error1'],
            ],
