...
class LineItemRepositoryTest extends WebTestCase
{
    ...
    public function testhasEmptyMatrixWhenOnlySimpleProductsWithSavedForLater(): void
    {
        $id = $this->getReference(LoadShoppingLists::SHOPPING_LIST_1)->getId();

        self::assertFalse($this->getLineItemRepository()->hasEmptyMatrix($id, true));
    }
    ...
    public function testcanBeGroupedWithSavedForLater(): void
    {
        $id = $this->getReference(LoadShoppingLists::SHOPPING_LIST_1)->getId();

        self::assertTrue($this->getLineItemRepository()->canBeGrouped($id));
        self::assertFalse($this->getLineItemRepository()->canBeGrouped($id, true));
    }
    ...
    public function testGetItemsWithProductByShoppingListWithSavedForLater(): void
    {
        $shoppingList = $this->getReference(LoadShoppingLists::SHOPPING_LIST_1);
