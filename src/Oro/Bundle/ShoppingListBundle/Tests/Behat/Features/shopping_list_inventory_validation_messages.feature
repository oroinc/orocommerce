...
Feature: Shopping list inventory validation messages
  ...
  Scenario: Validation messages in proper places
    ...
    When I type "4" in "Shopping List Line Item 2 Quantity"
    And I click on empty space
    ...
    When I type "4" in "Shopping List Line Item 1 Quantity"
    And I click on empty space
    ...
    And I should see "Shopping List Line Item Error" element with text "You cannot order less than 5 units of SKU123: testname" inside "Shopping List Line Item 2" element
    When I type "11" in "Shopping List Line Item 1 Quantity"
    And I click on empty space
