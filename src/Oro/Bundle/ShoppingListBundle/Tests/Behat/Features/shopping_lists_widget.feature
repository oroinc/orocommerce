...
Feature: Shopping Lists Widget
  ...
  Scenario: Check Show All in Shopping Lists Widget is enabled
    ...
    Then the "Show All Lists in Shopping List Widgets" checkbox should be checked
  ...
  Scenario: Disable Show All in Shopping Lists Widget
    ...
    When I fill "Shopping List Configuration Form" with:
      ...
      | Show All Lists in Shopping List Widgets             | false |
    And click "Save settings"
    Then I should see "Configuration saved" flash message
    And the "Show All Lists in Shopping List Widgets" checkbox should be unchecked
