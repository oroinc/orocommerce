...
Feature: Product kits on shopping list page
  ...
  Scenario: Check shopping list view page
    ...
    Then I should see following grid:
      ...
      | product-kit-01    | Product Kit 1 Product Kit 1 Line Item 1 Notes | In Stock     | 2   | pieces | $124.6845 | $249.37 -$124.685 $124.69 |
      | simple-product-03 | Barcode Scanner: Product 3                    |              | 2   | pieces | $37.0368  |                           |
      | simple-product-02 | Base Unit: Product 2                          |              | 2   | pieces | $24.6912  |                           |
      | product-kit-01    | Product Kit 1 Product Kit 1 Line Item 2 Notes | In Stock     | 1   | piece  | $13.5845  | $13.58 -$6.79 $6.79       |
      | simple-product-01 | Base Unit: Product 1                          |              | 1   | piece  | $12.3456  |                           |
      | product-kit-01    | Product Kit 1                                 | In Stock     | 1   | piece  | $25.9245  | $25.92 -$12.96 $12.96     |
      | simple-product-02 | Base Unit: Product 2                          |              | 1   | piece  | $24.6912  |                           |
      | simple-product-02 | Product 2                                     | In Stock     | 1   | piece  | $24.6912  | $24.69 -$12.345 $12.35    |
      | simple-product-04 | Configurable Product 1 Color: Red Size: M     | In Stock     | 1   | piece  | $49.3824  | $49.38 -$24.69 $24.69     |
      | simple-product-05 | Configurable Product 1 Color: Green Size: L   | Out of Stock | 2   | pieces | $61.728   | $123.46 -$61.73 $61.73    |
      | simple-product-06 | Configurable Product 1 Color: Blue Size: S    | Out of Stock | 3   | pieces | $74.0736  | $222.22 -$111.11 $111.11  |
  ...
  Scenario: Check shopping list edit page
    ...
    Then I should see following grid:
      ...
      | product-kit-01    | Product Kit 1 Product Kit 1 Line Item 1 Notes | In Stock     | 2 piece        | $124.6845 | $249.37 -$124.685 $124.69 |
      | simple-product-03 | Barcode Scanner: Product 3                    |              | 2 pieces       | $37.0368  |                           |
      | simple-product-02 | Base Unit: Product 2                          |              | 2 pieces       | $24.6912  |                           |
      | product-kit-01    | Product Kit 1 Product Kit 1 Line Item 2 Notes | In Stock     | 1 piece        | $13.5845  | $13.58 -$6.79 $6.79       |
      | simple-product-01 | Base Unit: Product 1                          |              | 1 piece        | $12.3456  |                           |
      ...
      | simple-product-02 | Product 2                                     | In Stock     | 1 piece        | $24.6912  | $24.69 -$12.345 $12.35    |
      | simple-product-04 | Configurable Product 1 Color: Red Size: M     | In Stock     | 1 piece        | $49.3824  | $49.38 -$24.69 $24.69     |
      | simple-product-05 | Configurable Product 1 Color: Green Size: L   | Out of Stock | 2 piece        | $61.728   | $123.46 -$61.73 $61.73    |
      | simple-product-06 | Configurable Product 1 Color: Blue Size: S    | Out of Stock | 3 piece        | $74.0736  | $222.22 -$111.11 $111.11  |
    And I should see "Summary 7 Items"
    And I should see "Subtotal $708.62"
    And I should see "Discount -$354.31"
    And I should see "Total $354.31"
  ...
  Scenario: Check SKU filter for grouped product variants
    ...
    Then I should see following grid:
      ...
      | simple-product-02 | Base Unit: Product 2                          |              | 1 piece        | $24.6912  |                           |
      | simple-product-02 | Product 2                                     | In Stock     | 1 piece        | $24.6912  | $24.69 -$12.345 $12.35    |
      |                   | Configurable Product 1                        |              | 6 pieces       |           | $395.06 -$197.53 $197.53  |
      | simple-product-04 | Color: Red Size: M                            | In Stock     | 1 piece        | $49.3824  | $49.38 -$24.69 $24.69     |
      | simple-product-05 | Color: Green Size: L                          | Out of Stock | 2 piece        | $61.728   | $123.46 -$61.73 $61.73    |
      | simple-product-06 | Color: Blue Size: S                           | Out of Stock | 3 piece        | $74.0736  | $222.22 -$111.11 $111.11  |
  ...
  Scenario: Inline edit product kit line item
    ...
    Then I should see following grid containing rows:
      | SKU               | Item                                          |          | Qty Update All | Price    | Subtotal               |
      | product-kit-01    | Product Kit 1 Product Kit 1 Line Item 2 Notes | In Stock | 2 piece        | $13.5845 | $27.17 -$13.585 $13.59 |
      | simple-product-01 | Base Unit: Product 1                          |          | 1 piece        | $12.3456 |                        |
