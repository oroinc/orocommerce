...
Feature: Product kits validation on shopping list page
  ...
  Scenario: Check shopping list view page
    ...
    Then I should see following grid:
      ...
      |                                 | Base Unit: Selection required                                                                                                    |              | 1      | piece  | $10.00 |          |
      |                                 | The selected kit configuration is not available for purchase. Please modify or remove this configuration from the shopping list. |              |        |        |        |          |

      | product-kit-01                  | Product Kit 1 Disabled optional kit item                                                                                         | IN STOCK     | 2      | pieces | $40.00 | $80.00   |
      |                                 | Barcode Scanner: Original selection no longer available                                                                          |              | 2      | pieces | $10.00 |          |
      | simple-product-01               | Base Unit: Product 1                                                                                                             |              | 1      | piece  | $10.00 |          |
      |                                 | The selected kit configuration is not available for purchase. Please modify or remove this configuration from the shopping list. |              |        |        |        |          |
      ...
      | simple-product-04               | Configurable Product 1 Color: Red Size: M                                                                                        | IN STOCK     | 1      | piece  | $10.00 | $10.00   |
      | simple-product-05               | Configurable Product 1 Color: Green Size: L                                                                                      | OUT OF STOCK | 2      | pieces | $10.00 | $20.00   |
      | simple-product-06               | Configurable Product 1 Color: Blue Size: S                                                                                       | OUT OF STOCK | 3      | pieces | $10.00 | $30.00   |
  ...
  Scenario: Check shopping list edit page
    ...
    Then I should see following grid:
      ...
      | simple-product-04               | Configurable Product 1 Color: Red Size: M                                                                                        | IN STOCK     | 1 piece        | $10.00 | $10.00   |
      | simple-product-05               | Configurable Product 1 Color: Green Size: L                                                                                      | OUT OF STOCK | 2 piece        | $10.00 | $20.00   |
      | simple-product-06               | Configurable Product 1 Color: Blue Size: S                                                                                       | OUT OF STOCK | 3 piece        | $10.00 | $30.00   |
  ...
  Scenario: Check shopping list edit page with grouped product variants
    ...
    Then I should see following grid:
      ...
      | simple-product-04               | Color: Red Size: M                                                                                                               | IN STOCK     | 1 piece        | $10.00 | $10.00   |
      | simple-product-05               | Color: Green Size: L                                                                                                             | OUT OF STOCK | 2 piece        | $10.00 | $20.00   |
      | simple-product-06               | Color: Blue Size: S                                                                                                              | OUT OF STOCK | 3 piece        | $10.00 | $30.00   |
