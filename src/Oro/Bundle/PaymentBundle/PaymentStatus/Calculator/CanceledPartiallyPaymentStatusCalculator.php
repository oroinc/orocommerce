...
/**
 * Calculates the payment status for an entity when the payment is canceled partially.
 *
 ...
 */
class CanceledPartiallyPaymentStatusCalculator implements PaymentStatusCalculatorInterface
{
    ...
    public function calculatePaymentStatus(
        ...
        if ($authorizedAmount->isGreaterThan($canceledAmount)) {
            return PaymentStatuses::CANCELED_PARTIALLY;
        }
