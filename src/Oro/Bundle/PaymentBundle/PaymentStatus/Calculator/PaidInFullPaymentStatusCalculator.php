...
/**
 * Calculates the payment status for an entity when the payment amount is paid in full.
 *
 ...
 */
class PaidInFullPaymentStatusCalculator implements PaymentStatusCalculatorInterface
{
    ...
    public function calculatePaymentStatus(
        ...
        $isPaidInFull = $this->paymentStatusCalculationHelper
            ->isTransactionsAmountGreaterThanOrEqual($successfulTransactions, $totalAmount);

        if ($isPaidInFull) {
            return PaymentStatuses::PAID_IN_FULL;
        }
