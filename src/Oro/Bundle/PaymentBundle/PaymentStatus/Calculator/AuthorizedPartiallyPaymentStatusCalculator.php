...
/**
 * Calculates the payment status for an entity when the payment is authorized partially.
 *
 ...
 */
class AuthorizedPartiallyPaymentStatusCalculator implements PaymentStatusCalculatorInterface
{
    ...
    public function calculatePaymentStatus(
        ...
        if ($this->paymentStatusCalculationHelper->isTransactionsAmountLessThan($authorizeTransactions, $totalAmount)) {
            return PaymentStatuses::AUTHORIZED_PARTIALLY;
        }
