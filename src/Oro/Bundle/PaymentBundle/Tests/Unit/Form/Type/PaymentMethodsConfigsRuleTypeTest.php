...
class PaymentMethodsConfigsRuleTypeTest extends FormIntegrationTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->formType = new PaymentMethodsConfigsRuleType($this->subscriber);
    }

    public function testGetBlockPrefix()
    {
        $this->assertEquals(PaymentMethodsConfigsRuleType::NAME, $this->formType->getBlockPrefix());
    }
    ...
    public function testSubmit($data)
    {
        ...
        $form->submit([
            'methodConfigs' => [['type' => 'code1', 'options' => []]],
        ...
        $this->assertEquals(
            (new PaymentMethodsConfigsRule())
                ...
                ->addMethodConfig((new PaymentMethodConfig())->setType('code1')),
            $form->getData()
        );
    }
