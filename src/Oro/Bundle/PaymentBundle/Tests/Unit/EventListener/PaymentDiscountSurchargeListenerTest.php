...
class PaymentDiscountSurchargeListenerTest extends \PHPUnit_Framework_TestCase
{
    const AMOUNT = 100;
    ...
    /** @var PaymentDiscountSurchargeListener */
    protected $listener;

    public function setUp()
    {
        $this->provider = $this->getMock(SubtotalProviderInterface::class);
        $this->listener = new PaymentDiscountSurchargeListener($this->provider);
    }
    ...
    public function testCollectSurchargeWithOneSubtotal()
    {
        ...
        $this->assertEquals(self::AMOUNT, $event->getSurchargeModel()->getDiscountAmount());
    }
    ...
    public function testCollectSurchargeWithFewSubtotals()
    {
        ...
        $this->assertEquals(60, $event->getSurchargeModel()->getDiscountAmount());
    }
    ...
    public function testCollectSurchargeWithEmptySubtotals()
    {
        ...
        $this->assertEquals(0, $event->getSurchargeModel()->getDiscountAmount());
    }
