...
class OrderFormHandler implements FormHandlerInterface
{
    ...
    public function __construct(
        ...
        private readonly NonDraftEntitiesEntityManagerIsolator $nonDraftEntitiesEntityManagerIsolator,
    ...
    private function persistOrder(FormInterface $form, Order $order): void
    {
        ...
        try {
            ...
            $this->nonDraftEntitiesEntityManagerIsolator->flushNonDraftEntities($entityManager);
