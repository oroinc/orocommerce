 ...
 */
class OrderProductKitItemLineItemType extends AbstractType
{
                    ...
                    ->create(
                        ...
                        [
                            ...
                            'placeholder' => !$options['required']
                                ? 'oro.order.form.orderproductkititemlineitem.product.choices.none'
                                : false,
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setDefault('data_class', OrderProductKitItemLineItem::class);
