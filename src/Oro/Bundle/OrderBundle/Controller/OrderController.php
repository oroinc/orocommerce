...
class OrderController extends AbstractController
{
    ...
    protected function update(Order $order, Request $request)
    {
        ...
        $formTemplateDataProviderComposite = $this->get(FormTemplateDataProviderComposite::class)
            ...
            ->addFormTemplateDataProviders($this->getOrderFormTemplateDataProvider());
    ...
    private function getOrderFormTemplateDataProvider(): callable
    {
        return function (Order $order, FormInterface $form, Request $request) {
