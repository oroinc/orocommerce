...
use Oro\Bundle\OrderBundle\Datagrid\DraftSession\OrderLineItemDraftUpdateDatagridListener;
use PHPUnit\Framework\TestCase;

final class OrderLineItemDraftUpdateDatagridListenerTest extends TestCase
{
    private OrderLineItemDraftUpdateDatagridListener $listener;

    #[\Override]
    protected function setUp(): void
    {
        $this->listener = new OrderLineItemDraftUpdateDatagridListener();
    }
    ...
    public function testOnBuildBeforeAddsProperty(): void
    {
        ...
        self::assertArrayHasKey('oro_order_line_item_draft_update', $properties);

        $property = $properties['oro_order_line_item_draft_update'];
        self::assertEquals('url', $property['type']);
        self::assertEquals('oro_order_line_item_draft_update', $property['route']);
