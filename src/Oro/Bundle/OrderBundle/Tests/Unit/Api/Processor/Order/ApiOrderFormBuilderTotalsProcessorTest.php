...
use Oro\Bundle\OrderBundle\Api\Processor\Order\ApiOrderFormBuilderTotalsProcessor;
use Oro\Component\ChainProcessor\ContextInterface;
use Symfony\Component\EventDispatcher\EventSubscriberInterface;
use Symfony\Component\Form\FormBuilderInterface;

class ApiOrderFormBuilderTotalsProcessorTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    /**
     * @var ApiOrderFormBuilderTotalsProcessor
     */
    ...
    public function setUp()
    {
        ...
        $this->testedProcessor = new ApiOrderFormBuilderTotalsProcessor($this->eventSubscriber);
    }
