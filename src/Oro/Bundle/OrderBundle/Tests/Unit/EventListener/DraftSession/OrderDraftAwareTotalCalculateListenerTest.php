...
final class OrderDraftAwareTotalCalculateListenerTest extends TestCase
{
    ...
    public function testOnBeforeTotalCalculateDoesNothingWhenFeaturesAreDisabled(): void
    {
    ...
    public function testOnBeforeTotalCalculateWhenIsBackendRequestLoadsOrderFromDraft(): void
    {
        $order = new Order();
        $request = new Request();
