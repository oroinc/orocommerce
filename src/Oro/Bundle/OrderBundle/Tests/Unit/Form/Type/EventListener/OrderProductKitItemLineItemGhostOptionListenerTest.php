...
class OrderProductKitItemLineItemGhostOptionListenerTest extends TestCase
{
    private OrderProductKitItemLineItemGhostOptionListener $listener;
    ...
    public function testOnPreSetDataWhenKitItemLineItemIsNew(): void
    {
        ...
        $formBuilder = $this->formFactory->createBuilder(FormType::class, new OrderProductKitItemLineItem())
            ->add('product', FormTypeStub::class, ['choices' => [$product1, $product2]])
            ->addEventSubscriber($this->listener);
    ...
    public function testOnPreSetDataWhenProductPresent(): void
    {
        ...
        $kitItemLineItem = (new OrderProductKitItemLineItemStub(42))
            ->setProduct($product1);
