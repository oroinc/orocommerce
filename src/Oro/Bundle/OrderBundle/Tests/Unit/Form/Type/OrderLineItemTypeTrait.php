...
trait OrderLineItemTypeTrait
{
    protected function createOrderLineItemType(
        ...
        $formType = new OrderLineItemType($productUnitsProvider);
        $formType->setDataClass(OrderLineItem::class);
        $formType->setSectionProvider($testCase->createMock(SectionProvider::class));
        $formType->setOrderLineItemProductListener(new OrderLineItemProductListener($entityStateChecker));
        $formType->setOrderLineItemChecksumListener(new OrderLineItemChecksumListener($lineItemChecksumGenerator));
