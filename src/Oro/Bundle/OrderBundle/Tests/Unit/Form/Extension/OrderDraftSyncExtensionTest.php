...
final class OrderDraftSyncExtensionTest extends TestCase
{
    ...
    public function testConfigureOptionsPreservesTrueWhenFeaturesAreEnabled(): void
    {
        $resolver = new OptionsResolver();
    ...
    public function testConfigureOptionsNormalizesToFalseWhenFeaturesAreDisabled(): void
    {
        ...
        $this->extension->addFeature('order_draft_edit_mode');
