...
final class OrderLineItemDraftDeleteControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        self::getConfigManager()->set('oro_order.enable_order_draft_edit_mode', true);
    ...
    protected function tearDown(): void
    {
        ...
        self::getConfigManager()->set('oro_order.enable_order_draft_edit_mode', false);
        self::getConfigManager()->flush();
    }
    ...
    public function testDeleteNewDraftLineItemRemovesDraftLineItem(): void
    {
        /** @var Order $order */
        $order = $this->getReference(LoadOrders::ORDER_2);
        ...
        self::assertNull($deletedLineItem);
    }
