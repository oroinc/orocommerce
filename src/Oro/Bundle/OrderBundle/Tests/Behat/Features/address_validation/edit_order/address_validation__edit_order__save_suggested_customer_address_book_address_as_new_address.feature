...
Feature: Address Validation - Edit Order - Save Suggested Customer Address Book Address as New Address
  As an Administrator
  ...
  Scenario: Create new customer address from suggested
    ...
    And I should see "ORO, 905 New Street, GAMBURG FL US 33987"
