...
Feature: Address Validation - Edit Order - Address Book Customer Address Replaced With New Suggested Address
  As an Administrator
  I should be able to fill the address book form on order edit page
  with a new address when customer save checkbox is not applied
