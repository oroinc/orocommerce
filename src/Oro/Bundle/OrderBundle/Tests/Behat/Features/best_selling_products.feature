...
Feature: Best Selling Products
  ...
  Scenario: Best Selling Products report
    ...
    And I have a complete calendar date table from "2016"
    ...
    And I filter Time Period as between "Jan 1, 2016 12:30 AM" and "Jan 3, 2016 11:30 AM"
    ...
    When I check "Month" in Grouping filter
    And I filter Time Period as not between "Jan 2, 2016 12:00 AM" and "Jun 1, 2016 10:30 AM"
    And I check "No" in Skip Empty Periods filter
    Then I should see following grid:
      | Time Period | SKU   | QTY Sold |
      | 6-2016      | 9OL25 | 4 Items  |
      | 1-2017      | 9OL25 | 10 Sets  |
      | 1-2016      | 9OL25 | 15 Sets  |
      | 1-2017      | 9OL25 | 20 Items |
      | 1-2016      | 9OL25 | 25 Items |
      | 6-2016      | 9OL25 | 56 Sets  |
      | 12-2017     |       | N/A      |
      | 12-2016     |       | N/A      |
