...
Feature: Configurable products in order history
  ...
  Scenario: Prepare product attributes
    ...
    And set Attribute Groups with:
      ...
      | Attribute group | true    | [SKU, Name, Is Featured, New Arrival, Brand, Description, Short Description, Images, Inventory Status, Meta title, Meta description, Meta keywords, Product prices, Size, Color] |
    And I save form
