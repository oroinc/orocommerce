...
/**
 * Fully hides externalId field of Order entity from grid, filters, view and edit form.
 */
class HideOrderExternalIdField implements Migration, ExtendOptionsManagerAwareInterface
{
