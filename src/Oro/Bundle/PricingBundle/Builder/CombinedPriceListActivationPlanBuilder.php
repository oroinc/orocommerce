...
class CombinedPriceListActivationPlanBuilder
{
     ...
     */
    public function setCombinedPriceListRelationHelper(CombinedPriceListRelationHelperInterface $relationHelper)
    {
    ...
    protected function combinedActualCombinedPriceList(array $priceListRelations, array $activePriceListIds)
    {
        ...
        return $this->combinedPriceListProvider->getCombinedPriceListWithEventOptions(
            $sequence,
