...
class VersionedPriceListProcessor implements MessageProcessorInterface, TopicSubscriberInterface, LoggerAwareInterface
{
    ...
    private CombinedPriceListActivationStatusHelperInterface $statusHandler;
    ...
    public function __construct(
        ...
        CombinedPriceListActivationStatusHelperInterface $statusHandler,
    ...
    private function getProductsForCombinedPriceList(CombinedPriceList $combinedPriceList, int $version): \Generator
    {
        ...
        foreach ($priceLists as $priceList) {
            yield from $this->getProductPriceRepository()->getProductsByPriceListIdAndVersion(
                $this->shardManager,
                $priceList,
                $version,
