...
class ProductController extends Controller
{
    ...
    {
        $relationsProvider = $this->get('oro_customer.provider.customer_user_relations_provider');

        $priceList = $this->get('oro_pricing.model.price_list_tree_handler')
            ->getPriceList($relationsProvider->getCustomerIncludingEmpty($this->getUser()));
