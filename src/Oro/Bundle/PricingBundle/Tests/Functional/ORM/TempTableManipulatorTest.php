...
class TempTableManipulatorTest extends WebTestCase
{
    ...
    public function testTempTableUsageInQb()
    {
        ...
        $this->assertContains('FROM ' . $tempTableName, $query->getSQL());
        $this->assertContains('JOIN ' . $tempTableName, $query->getSQL());
        ...
        $this->assertContains('FROM ' . $tempTableName, $query2->getSQL());
