...
class TempTableManipulatorTest extends WebTestCase
{
    ...
    public function testTempTableUsageInQb()
    {
        ...
        $this->assertContains('FROM ' . $tempTableName1, $query->getSQL());
        $this->assertContains('JOIN ' . $tempTableName2, $query->getSQL());
        ...
        $this->assertContains('FROM ' . $tempTableName1, $query2->getSQL());
