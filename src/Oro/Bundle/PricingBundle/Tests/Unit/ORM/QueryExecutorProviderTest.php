...
class QueryExecutorProviderTest extends TestCase
{
    ...
    /**
     * @var InsertFromSelectShardQueryExecutor|MockObject
     */
    private $insertFromSelectExecutor;

    /**
     * @var MultiInsertShardQueryExecutor|MockObject
     */
    private $multiInsertQueryExecutor;

    /**
     * @var QueryExecutorProvider
     */
    private $provider;
