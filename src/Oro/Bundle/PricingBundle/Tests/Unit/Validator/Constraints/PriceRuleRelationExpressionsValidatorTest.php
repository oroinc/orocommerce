    ...
    public function validateCurrencyFailDataProvider()
    {
        return [
            'test_to_many_nodes' => [
                ...
                'messageParams' => ['%fieldName%' => 'oro.pricing.pricerule.currency.label'],
    ...
    public function validateCurrencyWithRuleExpressionFailDataProvider()
    {
        return [
            'test_relation_field_is_not_currency' => [
                ...
                'messageParams' => [
                    '%fieldName%' => 'quantity',
                    '%inputName%' => 'oro.pricing.pricerule.currency.label'
                ],
            ...
            'test_relation_exists_in_rule_condition' => [
                ...
                'messageParams' => [
                    '%relationName%' => 'msrp',
                    '%fieldName%' => 'oro.pricing.pricerule.currency.label'
                ],
                'parsedCurrencyExpression' => new RelationNode(
                    'Oro\Bundle\ProductBundle\Entity\Product',
                    'msrp',
    ...
    public function validateQuantityFailDataProvider()
    {
        return [
            'test_more_then_one_relation_node' => [
                ...
                'messageParams' => ['%fieldName%' => 'oro.pricing.pricerule.quantity.label'],
    ...
    public function validateQuantityWithRuleExpressionFailDataProvider()
    {
        return [
            'test_relation_exists_in_rule_condition' => [
                ...
                'messageParams' => [
                    '%relationName%' => 'msrp',
                    '%fieldName%' => 'oro.pricing.pricerule.quantity.label'
                ],
    ...
    public function validateProductUnitFailDataProvider()
    {
        return [
            'test_to_many_nodes' => [
                ...
                'message' => PriceRuleRelationExpressionsValidator::ONE_EXPRESSION_ALLOWED_MESSAGE,
                'messageParams' => ['%fieldName%' => 'oro.pricing.pricerule.product_unit.label'],
    ...
    public function validateProductUnitWithRuleExpressionFailDataProvider()
    {
        return [
            'test_relation_not_product_unit_holder' => [
                ...
                'messageParams' => [
                    '%fieldName%' => 'quantity',
                    '%inputName%' => 'oro.pricing.pricerule.product_unit.label'
                ],
            ...
            'test_relation_exists_in_rule_condition' => [
                ...
                'messageParams' => [
                    '%relationName%' => 'msrp',
                    '%fieldName%' => 'oro.pricing.pricerule.product_unit.label'
                ],
                'parsedUnitExpression' => new RelationNode(
                    'Oro\Bundle\ProductBundle\Entity\Product',
                    'msrp',
