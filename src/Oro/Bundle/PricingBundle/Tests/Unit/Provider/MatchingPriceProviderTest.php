...
class MatchingPriceProviderTest extends TestCase
{
    ...
    public function testGetMatchingPricesWhenNoProductPriceCriteriaFactory(): void
    {
        $priceScopeCriteria = $this->createMock(ProductPriceScopeCriteriaInterface::class);
        ...
        $productPriceCriteria1 = new ProductPriceCriteria($product1, $productUnit, $qty, $currency);
        $productPriceCriteria2 = new ProductPriceCriteria($product2, $productUnit, $qty, $currency);
        ...
        $this->productPriceProvider->expects(self::once())
            ->method('getMatchedPrices')
            ->with(self::equalTo([$productPriceCriteria1, $productPriceCriteria2]), $priceScopeCriteria)
            ->willReturn($expectedMatchedPrices);
