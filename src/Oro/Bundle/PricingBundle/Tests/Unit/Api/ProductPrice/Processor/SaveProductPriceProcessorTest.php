...
use Oro\Bundle\PricingBundle\Api\ProductPrice\Processor\SaveProductPriceProcessor;
use Oro\Bundle\PricingBundle\Entity\ProductPrice;
use Oro\Bundle\PricingBundle\Manager\PriceManager;
use PHPUnit\Framework\TestCase;

class SaveProductPriceProcessorTest extends TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->processor = new SaveProductPriceProcessor($this->priceManager);
    }
