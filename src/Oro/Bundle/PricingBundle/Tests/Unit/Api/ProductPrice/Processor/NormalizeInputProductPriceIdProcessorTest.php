...
use Oro\Bundle\PricingBundle\Api\ProductPrice\Processor\NormalizeInputProductPriceIdProcessor;
use PHPUnit\Framework\TestCase;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Symfony\Component\Validator\Validator\ValidatorInterface;

class NormalizeInputProductPriceIdProcessorTest extends TestCase
{
    /**
    ...
    /**
     * @var NormalizeInputProductPriceIdProcessor
     */
    private $processor;
    ...
    protected function setUp()
    {
        ...
        $this->processor = new NormalizeInputProductPriceIdProcessor(
