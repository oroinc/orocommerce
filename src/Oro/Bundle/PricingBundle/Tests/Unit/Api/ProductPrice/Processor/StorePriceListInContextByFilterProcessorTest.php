...
use Oro\Bundle\PricingBundle\Api\ProductPrice\Processor\StorePriceListInContextByFilterProcessor;
use Oro\Bundle\PricingBundle\Entity\PriceList;
use PHPUnit\Framework\TestCase;

class StorePriceListInContextByFilterProcessorTest extends TestCase
{
    ...
    /**
     * @var StorePriceListInContextByFilterProcessor
     */
    private $processor;
    ...
    protected function setUp()
    {
        ...
        $this->processor = new StorePriceListInContextByFilterProcessor(
