...
use Oro\Bundle\PricingBundle\Api\ProductPrice\Processor\NormalizeOutputProductPriceIdProcessor;
use Oro\Bundle\PricingBundle\Api\ProductPrice\ProductPriceIDByContextNormalizerInterface;
use Oro\Component\ChainProcessor\ContextInterface;
use PHPUnit\Framework\TestCase;

class NormalizeOutputProductPriceIdProcessorTest extends TestCase
{
    /**
    ...
    /**
     * @var NormalizeOutputProductPriceIdProcessor
     */
    private $processor;
    ...
    protected function setUp()
    {
        ...
        $this->processor = new NormalizeOutputProductPriceIdProcessor($this->normalizer);
    }
