...
use Oro\Bundle\PricingBundle\Api\ProductPrice\Processor\LoadNormalizedProductPriceWithNormalizedIdProcessor;
use Oro\Bundle\PricingBundle\Api\ProductPrice\ProductPriceIDByContextNormalizerInterface;
use Oro\Component\ChainProcessor\ActionProcessorInterface;

class LoadNormalizedProductPriceWithNormalizedIdProcessorTest extends FormProcessorTestCase
{
    /**
    ...
    /**
     * @var LoadNormalizedProductPriceWithNormalizedIdProcessor
     */
    private $processor;
    ...
    protected function setUp()
    {
        ...
        $this->processor = new LoadNormalizedProductPriceWithNormalizedIdProcessor(
            $this->processorBag,
            $this->normalizer
        );
    }
