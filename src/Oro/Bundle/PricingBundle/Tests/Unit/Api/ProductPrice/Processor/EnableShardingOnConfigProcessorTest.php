...
use Oro\Bundle\PricingBundle\Api\ProductPrice\Processor\EnableShardingOnConfigProcessor;
use Oro\Bundle\PricingBundle\ORM\Walker\PriceShardWalker;
use Oro\Bundle\PricingBundle\Sharding\ShardManager;
use PHPUnit\Framework\TestCase;

class EnableShardingOnConfigProcessorTest extends TestCase
{
    /**
    ...
    /**
     * @var EnableShardingOnConfigProcessor
     */
    private $processor;
    ...
    protected function setUp()
    {
        ...
        $this->processor = new EnableShardingOnConfigProcessor(
            $this->shardManager,
