...
use Oro\Bundle\PricingBundle\EventListener\ImportExportResultListener;
...
class ImportExportResultListenerTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $event = new PostHttpImportEvent(['price_list_id' => 2]);
        ...
        $this->listener->postHttpImport($event);
    }

    public function testPostPersistWithoutOption()
    {
        $event = new PostHttpImportEvent([]);
