...
class VersionedPriceListProcessorTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->statusHandler = $this->createMock(CombinedPriceListActivationStatusHelperInterface::class);
    ...
    public function testProcessException(): void
    {
        ...
        $this->processor->setTopic(new ResolveCombinedPriceByVersionedPriceListTopic());
        $this->assertEquals(
    ...
    public function testProcess(): void
    {
        ...
        $productPriceRepository
            ->expects($this->once())
            ->method('getProductsByPriceListIdAndVersion')
