...
Feature: Product prices audit
  ...
  Scenario: Enable product prices audit
    Given I switch to the "ProductPrice" session
    And login as administrator
    And go to System/Entities/Entity Management
    And I filter "Name" as is equal to "PriceList"
    And click view "Price List" in grid
    And click edit "prices" in grid
    And fill form with:
      | Auditable | Yes |
    And save and close form
    And I should see "Field saved" flash message
    And go to System/Entities/Entity Management
    And I filter "Name" as is equal to "ProductPrice"
    And click edit "Product Price" in grid
    And fill form with:
      | Auditable | Yes |
    And save and close form
  ...
  Scenario: Check updated product price from the product edit page
    ...
    Then should see following "Audit History Grid" grid:
      | Old Values | New Values                                                                                                                                                       |
      | Prices:    | Prices:  Product Price "PSKU1 \| 2 item \| 10.4500 EUR" changed: Currency: USD EUR Quantity: 1 2 Unit: Product Unit "each" Product Unit "item" Value: 7.45 10.45 |
      | Prices:    | Prices:  Product Price "PSKU1 \| 1 each \| 7.4500 USD" added: Currency: USD Price List: Price List "1" Quantity: 1 Unit: Product Unit "each" Value: 7.45         |
    And close ui dialog
  ...
  Scenario: Check updated product price from the price list view page
    ...
    Then should see following "Audit History Grid" grid:
      | Old Values                                                                                                                                                    | New Values                                                                                                                                                       |
      | Prices:                                                                                                                                                       | Prices:  Product Price "PSKU1 \| 4 item \| 6.7500 EUR" changed: Currency: USD EUR Quantity: 3 4 Unit: Product Unit "each" Product Unit "item" Value: 5.65 6.75   |
      | Prices:                                                                                                                                                       | Prices:  Product Price "PSKU1 \| 3 each \| 5.6500 USD" added: Currency: USD Price List: Price List "1" Quantity: 3 Unit: Product Unit "each" Value: 5.65         |
      | Prices: Product Price "PSKU1 \| 2 item \| 10.4500 EUR" removed: Currency: EUR Price List: Price List "1" Quantity: 2 Unit: Product Unit "item" Value: 10.4500 | Prices:                                                                                                                                                          |
      | Prices:                                                                                                                                                       | Prices:  Product Price "PSKU1 \| 2 item \| 10.4500 EUR" changed: Currency: USD EUR Quantity: 1 2 Unit: Product Unit "each" Product Unit "item" Value: 7.45 10.45 |
      | Prices:                                                                                                                                                       | Prices:  Product Price "PSKU1 \| 1 each \| 7.4500 USD" added: Currency: USD Price List: Price List "1" Quantity: 1 Unit: Product Unit "each" Value: 7.45         |
