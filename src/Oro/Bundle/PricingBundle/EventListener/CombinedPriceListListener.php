 ...
 * Actualize activation rules on CombinedPriceListActualizeScheduleEvent.
 */
class CombinedPriceListListener
{
    ...
    public function onActualizeSchedule(CombinedPriceListActualizeScheduleEvent $event): void
    {
        $this->activationPlanBuilder->buildByCombinedPriceList($event->getCombinedPriceList());
    }
}
