...
import $ from 'jquery';
import AbstractSwitcher from 'oropricing/js/app/views/abstract-switcher';
...
const ExpressionFieldSwitcher = AbstractSwitcher.extend({
    ...
    initialize: function(options) {
        ...
        this.initLayout().then(this.initSwitcher.bind(this));
...
export default ExpressionFieldSwitcher;
