...
class PriceListImportCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $priceListId = $this->getPriceListId($input);
     ...
     * @return bool|mixed
     */
    protected function getPriceListId(InputInterface $input)
    {
        $priceListId = $input->hasOption('priceListId') ? $input->getOption('priceListId') : null;
        if (null === $priceListId) {
