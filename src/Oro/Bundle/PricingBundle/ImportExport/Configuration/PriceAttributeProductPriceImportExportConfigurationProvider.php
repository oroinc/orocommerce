...
/**
 * Provides import/export configuration for price attribute product prices.
 *
 * Defines the configuration for importing and exporting price attribute product prices,
