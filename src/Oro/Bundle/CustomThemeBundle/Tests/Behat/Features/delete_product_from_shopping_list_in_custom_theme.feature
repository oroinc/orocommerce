...
Feature: Delete product from Shopping List in custom theme
  In order to have ability to manage shopping list
  As a Buyer
  I want to delete products from Shopping list on shopping list view page or using popup in custom theme
