...
/**
 * b2b_flow_checkout_new_shipping_address operation logic implementation
 */
class NewShippingAddress extends AbstractOperationService
{
    ...
    public function execute(ActionData $data): void
    {
        ...
        $this->updateCheckoutState($checkout);
    ...
    private function updateCheckoutState(Checkout $checkout): void
    {
