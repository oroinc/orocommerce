 ...
 */
class CheckoutAvailableShippingAddress extends FrontendRestJsonApiTestCase
{
    #[\Override]
    ...
    private function getAutoCreatedCustomerUserShippingAddress(): CustomerUserAddress
    {
    ...
    public function testCheckoutGetSubresource(): void
    {
        $response = $this->getSubresource([
            ...
            'association' => 'availableShippingAddresses'
        ]);
        $this->assertResponseContains(
            [
                'data' => [
                    ...
                    [
                        'type' => 'checkoutavailableaddresses',
                        'id' => 'au_' . $this->getAutoCreatedCustomerUserShippingAddress()->getId(),
                        'attributes' => [
                            'group' => 'My address book',
                            'title' => 'John Doe, 2413 Capitol Avenue, ROMNEY FL US 47981'
                        ],
                        'relationships' => [
                            'address' => [
                                'data' => [
                                    'type' => 'customeruseraddresses',
                                    'id' => (string)$this->getAutoCreatedCustomerUserShippingAddress()->getId()
                                ]
                            ]
                        ]
                    ]
