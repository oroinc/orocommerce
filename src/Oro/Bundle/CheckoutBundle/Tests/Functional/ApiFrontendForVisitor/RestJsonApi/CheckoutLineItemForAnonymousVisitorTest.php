 ...
 * @dbIsolationPerTest
 */
class CheckoutLineItemForAnonymousVisitorTest extends FrontendRestJsonApiTestCase
{
    #[\Override]
    ...
    {
        $response = $this->cget(['entity' => 'checkoutlineitems'], [], ['HTTP_X-Include' => 'totalCount']);
