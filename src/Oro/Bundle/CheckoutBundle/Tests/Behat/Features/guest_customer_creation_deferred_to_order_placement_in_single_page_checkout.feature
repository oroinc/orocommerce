...
Feature: Guest customer creation deferred to order placement in single page checkout
  In order to have tax correctly applied for a guest whose customer user does not exist yet
  As a store administrator
  I want guest customer creation deferred to order placement in single page checkout
