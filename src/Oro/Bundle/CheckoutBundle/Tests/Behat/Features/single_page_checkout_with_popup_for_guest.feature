...
Feature: Single Page Checkout With Popup for Guest
  ...
  Scenario: Validate new billing address form and empty billing address notification
    ...
    And I should see "Please select an address" for "Select Single Page Checkout Billing Address" select
    ...
    Then I should see "Please select an address" for "Select Single Page Checkout Billing Address" select
  ...
  Scenario: Fill and save shipping address via popup and create order
    And I should see "Please select an address" for "Select Single Page Checkout Shipping Address" select
