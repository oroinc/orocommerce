...
Feature: Address Validation - Single-Page - Billing - Address Book Customer User Address Replaced With New Suggested Address
  As an Buyer
  I should be able to replace the billing customer user address on single step checkout
  with a new address
