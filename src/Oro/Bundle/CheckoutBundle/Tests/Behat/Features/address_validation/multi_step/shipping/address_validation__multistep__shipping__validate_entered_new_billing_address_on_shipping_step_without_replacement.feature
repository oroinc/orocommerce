...
Feature: Address Validation - Multi-Step - Shipping - Validate Entered New Billing Address On Shipping Step Without Replacement
  As a Buyer
  I should see that address validation dialog displayed on shipping step
  when use billing address checkbox is applied and entered address is selected as validated
