...
Feature: Address Validation - Multi-Step - Shipping - Validate Entered New Address Without Replacement And No Predefined Addresses
  As a Buyer
  I should see that address validation dialog displayed and
  address details were not changed after address validation on checkout shipping address
