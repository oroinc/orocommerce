...
Feature: Address Validation - Multi-Step - Billing - Validate Entered Guest New Address Without Replacement
  As a Buyer
  I should see that address validation dialog displayed and
  address details were not changed after address validation on checkout billing address on guest checkout
