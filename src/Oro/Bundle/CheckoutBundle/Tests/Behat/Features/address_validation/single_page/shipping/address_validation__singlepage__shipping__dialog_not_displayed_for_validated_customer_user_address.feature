...
Feature: Address Validation - Single-Page - Shipping - Dialog Not Displayed For Validated Customer User Address
  As an Buyer
  ...
  Scenario: Update selected customer address with suggested
    ...
    And I select "ORO, 805 Scenic Hwy, HAINES CITY FL US 33844" from "Shipping Address"
