...
Feature: Address Validation - Single-Page - Billing - Validate Entered New Address Without Replacement
  As a Buyer
  I should see that address validation dialog displayed and
  billing address details were not changed after address validation on single step checkout
