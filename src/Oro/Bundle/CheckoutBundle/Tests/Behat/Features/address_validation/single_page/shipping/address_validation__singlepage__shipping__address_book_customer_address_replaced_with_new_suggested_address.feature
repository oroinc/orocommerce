...
Feature: Address Validation - Single-Page - Shipping - Address Book Customer Address Replaced With New Suggested Address
  As an Buyer
  I should be able to replace the shipping customer address on single step checkout
  with a new address
