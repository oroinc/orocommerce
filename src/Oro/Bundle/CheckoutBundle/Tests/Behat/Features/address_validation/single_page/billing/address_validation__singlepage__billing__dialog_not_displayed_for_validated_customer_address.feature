...
Feature: Address Validation - Single-Page - Billing - Dialog Not Displayed For Validated Customer Address
  As an Buyer
  ...
  Scenario: Update selected customer address with suggested
    ...
    And I select "ORO, 4444 Hard Road, YORK NY US 12103" from "Billing Address"
