...
class ShippingMethodActionsTest extends TestCase
{
    ...
    private CheckoutLineItemsShippingManager|MockObject $checkoutLineItemsShipping;
    private CheckoutLineItemGroupsShippingManager|MockObject $checkoutLineItemGroupsShipping;
    ...
    protected function setUp(): void
    {
        ...
        $this->checkoutLineItemsShipping = $this->createMock(CheckoutLineItemsShippingManager::class);
        $this->checkoutLineItemGroupsShipping = $this->createMock(CheckoutLineItemGroupsShippingManager::class);
