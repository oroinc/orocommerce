...
class ShoppingListLineItemDiffMapperTest extends AbstractCheckoutDiffMapperTest
{
    ...
    /** @var CheckoutShippingContextProvider|MockObject */
    ...
    public function testIsStatesEqualTrue(): void
    {
        ...
        $this->getConfigManagerReturn(true);
    ...
    public function testIsStatesEqualDisableConfig(): void
    {
        $state1 = [
            'sSKU123-uset-q1-pUSD120-w10kg-d1x1x1cm-iin_stock'
        ];
        ...
        $this->checkout->setOrganization($organization);
    ...
    /**
     * {@inheritdoc}
     * @return ShoppingListLineItemDiffMapper|CheckoutStateDiffMapperInterface
     */
    protected function getMapper(): ShoppingListLineItemDiffMapper
    {
        return new ShoppingListLineItemDiffMapper($this->configManager, $this->shipContextProvider);
    }
