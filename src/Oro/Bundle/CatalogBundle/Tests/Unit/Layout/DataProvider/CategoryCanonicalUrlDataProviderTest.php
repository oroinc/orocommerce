...
class CategoryCanonicalUrlDataProviderTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->canonicalUrlDataProvider->setContentNodeProvider($this->contentNodeProvider);
        $this->canonicalUrlDataProvider->setCanonicalUrlGenerator($this->canonicalUrlGenerator);
        $this->canonicalUrlDataProvider->setRoutingInformationProvider($this->routingInformationProvider);
