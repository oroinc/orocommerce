...
class CategorySortOrderGridTypeStub extends CategorySortOrderGridType
{
    ...
    {
        $view->vars['sortOrderConstraints'] = json_decode(
            '{"Oro\\Bundle\\ValidationBundle\\Validator\\Constraints\\Decimal":{"payload":null,"message":"This value should be decimal number."},"Range":{"payload":null,"notInRangeMessage":"This value should be between {{ min }} and {{ max }}.","minMessage":"This value should be {{ limit }} or more.","maxMessage":"This value should be {{ limit }} or less.","invalidMessage":"This value should be a valid number.","invalidDateTimeMessage":"This value should be a valid datetime.","min":0,"minPropertyPath":null,"max":null,"maxPropertyPath":null,"deprecatedMinMessageSet":false,"deprecatedMaxMessageSet":false}}',
            true
        );
    }
}
