...
Feature: Product Import with Category Identification
  ...
  Scenario: Setup duplicate and mismatched categories resolution like in version 6.1
    # We set the initial values of the config options to match the 6.1 default state, to allow for easier backporting of
    # changes to this test to the maintenance branches. All configuration options are covered by this test either way.
