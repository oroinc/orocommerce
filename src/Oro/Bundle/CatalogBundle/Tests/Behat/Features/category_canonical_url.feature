...
Feature: Category canonical url
  ...
  Scenario: Configure Canonical URL to use Direct URLs only
    Given I proceed as the Admin
    When uncheck "Use default" for "Prefer Self-Contained Web Catalog Canonical URLs" field
    And I check "Prefer Self-Contained Web Catalog Canonical URLs"
    And I submit form
    Then I should see "Configuration saved" flash message
  ...
  Scenario: Configure Canonical URL to use Direct URLs only
    Given I proceed as the Admin
    When I uncheck "Prefer Self-Contained Web Catalog Canonical URLs"
    And I submit form
    Then I should see "Configuration saved" flash message
