...
namespace Oro\Bundle\WebsiteSearchTermBundle\Migrations\Schema\v1_0;
...
/**
 * Creates website search term table and relations.
 */
class CreateSearchTermMigration implements Migration
{
    #[\Override]
    ...
    private function addRelationsForSearchTermScopesTable(Schema $schema)
    {
