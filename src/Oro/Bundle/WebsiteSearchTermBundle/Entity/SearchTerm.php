 ...
 * @ORM\Entity(repositoryClass="Oro\Bundle\WebsiteSearchTermBundle\Entity\Repository\SearchTermRepository")
 * @Config(
    ...
    OrganizationAwareInterface
{
    ...
    /**
     * @ORM\Column(name="phrases", type="text", nullable=false)
     */
    protected ?string $phrases = '';

    /**
     * @ORM\Column(name="action_type", type="string", length=128, nullable=false)
     */
    protected ?string $actionType = '';

    /**
     * @ORM\Column(name="modify_action_type", type="string", length=128, nullable=true)
     */
    protected ?string $modifyActionType = '';

    /**
     * @ORM\Column(name="redirect_action_type", type="string", length=128, nullable=true)
     */
    ...
    /**
     * @ORM\Column(name="redirect_system_page", type="text", nullable=true)
     */
    protected ?string $redirectSystemPage = null;

    /**
     * @ORM\Column(name="redirect_301", type="boolean", nullable=false, options={"default"=false})
     */
    ...
    /**
     * @ORM\Column(name="partial_match", type="boolean", nullable=false, options={"default"=false})
     */
