...
class CreditCardMethodProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var PayPalCreditCardPaymentMethodFactoryInterface|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $factory;
    ...
    protected function setUp()
    {
        ...
        $this->creditCardMethodProvider = new CreditCardMethodProvider($this->configProvider, $this->factory);
    }
    ...
    public function testGetPaymentMethodForCorrectIdentifier()
    {
        ...
        static::assertEquals($method, $this->creditCardMethodProvider->getPaymentMethod(self::IDENTIFIER1));
    }
