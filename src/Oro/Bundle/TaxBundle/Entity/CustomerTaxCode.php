 ...
 */
#[ORM\Entity(repositoryClass: CustomerTaxCodeRepository::class)]
#[ORM\Table(name: 'oro_tax_customer_tax_code')]
#[ORM\UniqueConstraint(name: 'oro_customer_tax_code_organization_unique_index', columns: ['code', 'organization_id'])]
