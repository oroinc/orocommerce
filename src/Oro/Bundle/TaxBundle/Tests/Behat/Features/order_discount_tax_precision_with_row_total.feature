...
Feature: Order discount tax precision with row total
  ...
  Scenario: Feature Background
    ...
    And I set configuration property "oro_tax.calculate_taxes_after_promotions" to "true"
  ...
  Scenario: Tax is calculated on correct taxable base with Start Calculation With Unit Price
    ...
    And I set configuration property "oro_tax.start_calculation_with" to "unit_price"
