...
class AjaxLocalizationController extends AbstractController
{
    ...
    public function setCurrentLocalizationAction(Request $request): JsonResponse
    {
        ...
        $localizationManager = $this->get('oro_frontend_localization.manager.user_localization');
        if ($localization instanceof Localization
            && array_key_exists($localization->getId(), $localizationManager->getEnabledLocalizations())
        ) {
            $localizationManager->setCurrentLocalization($localization, null, true);
    ...
    public static function getSubscribedServices(): array
    {
        return array_merge(
            ...
            [
                ...
                'oro_frontend_localization.manager.user_localization' => UserLocalizationManager::class,
