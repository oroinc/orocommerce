...
class LoadConsentDemoData extends AbstractLoadWebCatalogDemoData implements DependentFixtureInterface
{
    ...
    {
        return [LoadWebCatalogDemoData::class, LoadConsentCmsPagesDemoData::class];
    }

    private function enableConsentFeature()
    {
        $configManager = $this->container->get('oro_config.global');
        $configManager->set(OroConsentExtension::ALIAS . '.' . Configuration::CONSENT_FEATURE_ENABLED, true);
