...
{
    public const CONSENT_OPTIONAL_NODE1_WITH_CMS = 'CONSENT_OPTIONAL_NODE1_WITH_CMS';
    public const CONSENT_OPTIONAL_NODE1_WITH_CMS_WITHOUT_ACCEPTANCES =
        'CONSENT_OPTIONAL_NODE1_WITH_CMS_WITHOUT_ACCEPTANCES';
    public const CONSENT_OPTIONAL_NODE1_WITH_SYSTEM = 'CONSENT_OPTIONAL_NODE1_WITH_SYSTEM';
    public const CONSENT_OPTIONAL_NODE2_WITH_CMS = 'CONSENT_OPTIONAL_NODE2_WITH_CMS';
    public const CONSENT_REQUIRED_NODE1_WITH_CMS = 'CONSENT_REQUIRED_NODE1_WITH_CMS';
    public const CONSENT_REQUIRED_NODE1_WITH_SYSTEM = 'CONSENT_REQUIRED_NODE1_WITH_SYSTEM';
    public const CONSENT_REQUIRED_NODE2_WITH_CMS = 'CONSENT_REQUIRED_NODE2_WITH_CMS';
    public const CONSENT_REQUIRED_WITHOUT_NODE = 'CONSENT_REQUIRED_WITHOUT_NODE';
    public const CONSENT_OPTIONAL_WITHOUT_NODE = 'CONSENT_OPTIONAL_WITHOUT_NODE';
