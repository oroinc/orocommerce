 ...
 */
class ProductRFPAvailabilityProvider implements ProductAvailabilityProviderInterface
{
    ...
    /**
     * @deprecated since 5.1, use isProductAllowedForRFP() instead.
     */
    public function isProductApplicableForRFP(Product $product)
    {
        return !\in_array($product->getType(), $this->notAllowedProductTypes, true);
    }
