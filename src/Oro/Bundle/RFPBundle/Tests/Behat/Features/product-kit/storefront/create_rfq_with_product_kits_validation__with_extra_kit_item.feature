...
Feature: Create RFQ with Product Kits Validation - with extra Kit Item
  ...
  Scenario: Remove a Kit Item from a Product Kit
  ...
  Scenario: Try to submit the Request
    ...
    And I should see "product-kit-01 - Product Kit 01 Optional Item 1 piece simple-product-03 - Simple Product 03 This form should not contain extra fields: \"1\". The selected kit configuration is not valid. Please modify or remove it." in the "RFQ Products List Line Item 1" element

  Scenario: Update and submit RFQ
    When click on "RFQ Kit Item Line Item 1 Configure Button"
    And click "Save"
    And click "Update Line Item"
    Then I should see "product-kit-01 - Product Kit 01 Optional Item 1 piece simple-product-03 - Simple Product 03" in the "RFQ Products List Line Item 1" element
    When I click "Submit Request"
  ...
  Scenario: Check RFQ with Product Kits in the admin area
    ...
    Then I should see next rows in "Request Line Items Table" table
      ...
      | product-kit-01 | Product Kit 01 Optional Item [piece x 1] Simple Product 03 | 1 pc               |
