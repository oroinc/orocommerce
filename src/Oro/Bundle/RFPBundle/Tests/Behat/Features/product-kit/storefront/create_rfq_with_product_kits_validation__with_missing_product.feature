...
Feature: Create RFQ with Product Kits Validation - with Missing Product
  ...
  Scenario: Remove a product from a Product Kit
    Given I proceed as the Admin
    When I login as administrator
    And go to Products / Products
    And click "Edit" on row "product-kit-01" in grid
    And I click "Kit Item 2 Toggler"
    And I click "Remove" on row "simple-product-01" in grid "Kit Item 2 Products Edit Grid"
  ...
  Scenario: Remove a product
    ...
    And click delete "simple-product-01" in grid
  ...
  Scenario: Try to submit the Request
    ...
    And I should see "product-kit-01 - Product Kit 01 Optional Item 1 piece simple-product-03 - Simple Product 03 Mandatory Item 1 piece Selection required The selected kit configuration is not valid. Please modify or remove it." in the "RFQ Products List Line Item 1" element

  Scenario: Update and submit RFQ
    When click on "RFQ Kit Item Line Item 1 Configure Button"
    And click "Save"
    And click "Update Line Item"
    Then I should see "product-kit-01 - Product Kit 01 Optional Item 1 piece simple-product-03 - Simple Product 03 Mandatory Item 1 piece simple-product-02 - Simple Product 02" in the "RFQ Products List Line Item 1" element
    When I click "Submit Request"
  ...
  Scenario: Check RFQ with Product Kits in the admin area
    ...
    Then I should see next rows in "Request Line Items Table" table
      ...
      | product-kit-01 | Product Kit 01 Optional Item [piece x 1] Simple Product 03 Mandatory Item [piece x 1] Simple Product 02 | 1 pc               |
