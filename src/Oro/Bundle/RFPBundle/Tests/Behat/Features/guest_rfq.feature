...
Feature: Guest RFQ
  ...
  Scenario: Submit RFQ from shopping list as guest
    ...
    And should see "0" in the "Shopping List Widget" element
    When I type "PSKU1" in "search"
    And click "Search Button"
    Then I should see "Product1"
    When I click "Add to Shopping List" for "PSKU1" product
    Then follow "Shopping List" link within flash message "Product has been added to \"Shopping list\""
    When I hover on "Shopping List Widget"
    Then I should see "1 item N/A" in the "Shopping List Widget" element
    And should see "$0.00" in the "Shopping List Widget" element
  ...
  Scenario: Check rfq in management console
    ...
    When I click "Edit"
    And click "Assigned To Tooltip Icon"
