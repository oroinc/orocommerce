...
use Oro\Bundle\RFPBundle\Form\Type\RequestProductKitItemLineItemCollectionType;
use Oro\Bundle\TestFrameworkBundle\Test\WebTestCase;
use Symfony\Component\HttpFoundation\Request;

class RequestProductKitItemLineItemCollectionTypeTest extends WebTestCase
{
    protected function setUp(): void
    {
        ...
        $this->loadFixtures([
            '@OroRFPBundle/Tests/Functional/Form/Type/DataFixtures/RequestProductKitItemLineItemCollectionType.yml',
        ]);
    ...
    public function testCreateWhenNoData(): void
    {
        ...
        self::assertContains(
            'oro_rfp_request_product_kit_item_line_item_collection',
