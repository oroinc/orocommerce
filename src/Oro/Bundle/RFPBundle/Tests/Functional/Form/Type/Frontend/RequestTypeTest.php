...
class RequestTypeTest extends FrontendWebTestCase
{
    protected function setUp(): void
    {
        ...
        $this->loadFixtures([
            '@OroRFPBundle/Tests/Functional/Form/Type/Frontend/DataFixtures/RequestType.yml',
            '@OroRFPBundle/Tests/Functional/Form/Type/Frontend/DataFixtures/RequestType.request.yml',
        ]);
    ...
    public function testCreateWhenNoData(): void
    {
        ...
        self::assertContains('oro_rfp_frontend_request', $formView->vars['block_prefixes']);
    }
     ...
     * @SuppressWarnings(PHPMD.ExcessiveMethodLength)
     */
    public function testSubmitShouldDeleteRequestProductWithoutProduct(): void
    {
        /** @var RequestEntity $requestEntity */
        $requestEntity = $this->getReference('request1');
        ...
        // Checks request products.
        self::assertCount(1, $requestEntity->getRequestProducts());
