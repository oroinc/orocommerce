...
namespace Oro\Bundle\RFPBundle\Tests\Unit\Datagrid\Extension;

use Oro\Bundle\CustomerBundle\Security\Token\AnonymousCustomerUserToken;
use Oro\Bundle\DataGridBundle\Datagrid\Common\DatagridConfiguration;
use Oro\Bundle\DataGridBundle\Datagrid\ParameterBag;
use Oro\Bundle\FrontendBundle\Request\FrontendHelper;
use Oro\Bundle\RFPBundle\Datagrid\Extension\FrontendRequestsGridExtension;
use Oro\Bundle\SecurityBundle\Authentication\TokenAccessorInterface;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;
use Symfony\Component\Security\Core\Authentication\Token\TokenInterface;

class FrontendRequestsGridExtensionTest extends TestCase
{
    private FrontendRequestsGridExtension $extension;
    ...
    protected function setUp(): void
    {
        ...
        $this->extension = new FrontendRequestsGridExtension(
            $this->tokenAccessor,
            $this->frontendHelper
        );
    ...
    public function isApplicableDataProvider(): array
    {
        return [
            'Applicable' => [
                'gridConfig' => ['name' => 'frontend-requests-grid'],
