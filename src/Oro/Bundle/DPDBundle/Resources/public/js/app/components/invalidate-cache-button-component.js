...
define(function(require) {
    ...
    var DPDInvalidateCacheComponent;
    var $ = require('jquery');
    var _ = require('underscore');
    var BaseComponent = require('oroui/js/app/components/base/component');

    DPDInvalidateCacheComponent = BaseComponent.extend({
        /**
         * @property {Object}
         */
        options: {
        ...
        dispose: function() {
            ...
            DPDInvalidateCacheComponent.__super__.dispose.call(this);
        }
    });

    return DPDInvalidateCacheComponent;
});
