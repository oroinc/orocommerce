...
use Oro\Bundle\DPDBundle\Handler\InvalidateCacheAtHandler;
...
class InvalidateCacheAtHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \PHPUnit_Framework_MockObject_MockObject|ZipCodeRulesCache
     */
    ...
    protected function setUp()
    {
        ...
        $this->zipCodeRulesCache = $this->getMockBuilder(ZipCodeRulesCache::class)
            ->disableOriginalConstructor()
    ...
    public function testProcessInvalidateNow()
    {
        ...
        $this->zipCodeRulesCache->expects(static::once())->method('deleteAll')->with(1);
