...
namespace Oro\Bundle\CMSBundle\Migrations\Schema\v1_14_2;
...
/**
 * Adds the column for SearchTerm::$contentBlock field
 */
class AddContentBlockToSearchTerm implements Migration, ExtendExtensionAwareInterface
{
