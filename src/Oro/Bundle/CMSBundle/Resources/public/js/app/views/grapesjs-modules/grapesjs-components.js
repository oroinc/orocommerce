define(function(require) {
    ...
    var TableComponents = require('orocms/js/app/views/grapesjs-modules/components/table');
    var TableResponsiveComponent = require('orocms/js/app/views/grapesjs-modules/components/table-responsive');
