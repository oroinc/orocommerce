...
import styleManagerExtends from 'orocms/js/app/grapesjs/plugins/components/style-manager-extends';
...
export default GrapesJS.plugins.add('grapesjs-components', function(editor, options) {
    ...
    editor.getCss = _.wrap(editor.getCss, (func, ...args) => twigSafeCssFilter(func.apply(editor, args)));
