...
class WYSIWYGTypeTest extends FormIntegrationTestCase
{
    ...
    public function testFinishView(): void
    {
        ...
        self::assertEquals(
            ...
            . ',"jsmodules":["orocms\/js\/app\/grapesjs\/plugins\/wysiwyg-icons"]'
            . ',"autoRender":true'
            . ',"builderPlugins":{"wysiwyg-icons":{"baseSvgSpriteUrl":'
            . '"\/build\/__theme__\/svg-icons\/theme-icons.svg"},"bar-plugin":{"foo":"baz"}}'
