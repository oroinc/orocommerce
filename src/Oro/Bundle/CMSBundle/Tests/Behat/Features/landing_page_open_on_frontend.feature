...
#  at the moment uploaded images cat1.jpg and cat2.jpg have following identifiers 4 & 5
...
Feature: Landing page open on frontend
  ...
  Scenario: Create Landing Page
    ...
    And I fill in WYSIWYG "CMS Page Content" with "cat1.jpg" image in "GrapesJS content: <img alt=\"cat1_wysiwyg_image\" src=\"{{ wysiwyg_image(cat1.jpg, 'f23ac0ff-2cc0-4d9e-8d00-78053a569a50') }}\"/><a title=\"cat1_wysiwyg_file\" href=\"{{ wysiwyg_file(cat1.jpg, '902dfb57-57c0-4a2f-88bf-adf365d74895') }}\">File of cat1</a>"
    When I save form
  ...
  Scenario: Add incorrect twig function
    ...
    And I fill in WYSIWYG "CMS Page Content" with "GrapesJS content: {{ test(123) }} <img alt=\"cat1_wysiwyg_image\" src=\"{{ wysiwyg_image(4, 'f23ac0ff-2cc0-4d9e-8d00-78053a569a50') }}\"/><a title=\"cat1_wysiwyg_file\" href=\"{{ wysiwyg_file(4, '902dfb57-57c0-4a2f-88bf-adf365d74895') }}\">File of cat1</a><img alt=\"cat2_wysiwyg_image\" src=\"{{ wysiwyg_image(5, 'c840eec3-4b10-4682-b5cd-4d51fe008b6f') }}\"/>"
    And I save form
  ...
  Scenario: Add another image
    When I fill in WYSIWYG "CMS Page Content" with "GrapesJS content: <img alt=\"cat1_wysiwyg_image\" src=\"{{ wysiwyg_image(4, 'f23ac0ff-2cc0-4d9e-8d00-78053a569a50') }}\"/><a title=\"cat1_wysiwyg_file\" href=\"{{ wysiwyg_file(4, '902dfb57-57c0-4a2f-88bf-adf365d74895') }}\">File of cat1</a><img alt=\"cat2_wysiwyg_image\" src=\"{{ wysiwyg_image(5, 'c840eec3-4b10-4682-b5cd-4d51fe008b6f') }}\"/>"
    When I save form
    Then I should not see text matching "\{\{ wysiwyg_image\(" in WYSIWYG editor
    And I should not see text matching "\{\{ wysiwyg_file\(" in WYSIWYG editor
    When I save and close form
