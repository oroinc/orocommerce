...
Feature: Image with svg mime type on Landing page
  ...
  Scenario: Create Landing Page
    ...
    And "Example1 svg wysiwyg picture source" element "srcset" attribute should contain ".svg"
    And "Example1 svg wysiwyg picture source" element "srcset" attribute should not contain ".svg.webp"
