...
Feature: WYSIWYG links
  ...
  Scenario: Add/update/delete link button type
    And I add new component "Link Button" from panel to:
      ...
      | grid-column | 2 |
    And I check wysiwyg content in "CMS Page Content":
      | 5 | <a class="btn btn--outline">Link Button</a> |
    And I select component in canvas by tree:
      | grid-row    | 1 |
      | grid-column | 2 |
      | link-button | 1 |
    And I update selected component settings:
      ...
      | Target | _blank              |
    And I check wysiwyg content in "CMS Page Content":
      | 5 | <a href="http://test-url.com" title="Test title" target="_blank" class="btn btn--outline">Test text</a> |
    And I update selected component "Typography" styles:
      | color | #000000 |
    ...
    And I check wysiwyg content in "CMS Page Content":
      | 3 | <a class="btn btn--outline">Link Button</a> |
      | 4 | <a class="btn btn--outline">Link Button</a> |
    And I save form
    And I check wysiwyg content in "CMS Page Content":
      | 3 | <a class="btn btn--outline">Link Button</a>                                                             |
      | 4 | <a class="btn btn--outline">Link Button</a>                                                             |
      | 7 | <a href="http://test-url.com" title="Test title" target="_blank" class="btn btn--outline">Test text</a> |
