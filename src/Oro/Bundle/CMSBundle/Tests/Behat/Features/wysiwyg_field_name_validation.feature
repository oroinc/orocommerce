@regression
Feature: WYSIWYG field name validation
  ...
  Scenario: Check import validation
    ...
    When I fill template with data:
      ...
      | wysiwyg_style      |               | wysiwyg | header_value        | order_value        | 0                     | yes             | label_value  | description_value  | order_value    | yes                 | priority_value | yes                      |
      | string             |               | wysiwyg | header_value        | order_value        | 0                     | yes             | label_value  | description_value  | order_value    | yes                 | priority_value | yes                      |
    And I import file
