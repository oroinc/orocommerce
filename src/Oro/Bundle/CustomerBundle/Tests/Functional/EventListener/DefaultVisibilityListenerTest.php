...
class DefaultVisibilityListenerTest extends WebTestCase
{
    ...
    public function onFlushDataProvider()
    {
        return [
            'category visibility' => [
                'entityClass' => 'Oro\Bundle\CustomerBundle\Entity\Visibility\CategoryVisibility',
                'parameters' => ['category'],
            ],
            'account category visibility' => [
                'entityClass' => 'Oro\Bundle\CustomerBundle\Entity\Visibility\AccountCategoryVisibility',
                'parameters' => ['category', 'account'],
            ],
            'account group category visibility' => [
                'entityClass' => 'Oro\Bundle\CustomerBundle\Entity\Visibility\AccountGroupCategoryVisibility',
                'parameters' => ['category', 'accountGroup'],
            ],
            'product visibility' => [
                'entityClass' => 'Oro\Bundle\CustomerBundle\Entity\Visibility\ProductVisibility',
                'parameters' => ['website', 'product'],
            ],
            'account product visibility' => [
                'entityClass' => 'Oro\Bundle\CustomerBundle\Entity\Visibility\AccountProductVisibility',
                'parameters' => ['website', 'product', 'account'],
            ],
            'account group product visibility' => [
                'entityClass' => 'Oro\Bundle\CustomerBundle\Entity\Visibility\AccountGroupProductVisibility',
