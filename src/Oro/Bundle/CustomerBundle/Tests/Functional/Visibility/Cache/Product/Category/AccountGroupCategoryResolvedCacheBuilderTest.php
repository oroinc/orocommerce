...
class AccountGroupCategoryResolvedCacheBuilderTest extends AbstractProductResolvedCacheBuilderTest
{
    ...
    public function testChangeAccountGroupCategoryVisibilityToHidden()
    {
        ...
        $em = $this->registry->getManagerForClass('OroCustomerBundle:Visibility\AccountGroupCategoryVisibility');
    ...
    protected function getVisibilityResolved()
    {
        ...
        $qb = $em->getRepository('OroCustomerBundle:VisibilityResolved\AccountGroupCategoryVisibilityResolved')
    ...
    {
        return $this->registry->getManagerForClass('OroCustomerBundle:Visibility\AccountGroupCategoryVisibility')
