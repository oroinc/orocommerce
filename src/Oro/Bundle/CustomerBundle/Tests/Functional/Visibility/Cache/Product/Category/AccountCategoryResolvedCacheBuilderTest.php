...
use Oro\Bundle\CustomerBundle\Visibility\Cache\Product\Category\AccountCategoryResolvedCacheBuilder;
use Oro\Bundle\CustomerBundle\Visibility\Cache\Product\Category\Subtree\VisibilityChangeAccountSubtreeCacheBuilder;
...
class AccountCategoryResolvedCacheBuilderTest extends AbstractProductResolvedCacheBuilderTest
{
    ...
    public function testChangeAccountCategoryVisibilityToHidden()
    {
        ...
        $em = $this->registry->getManagerForClass('OroCustomerBundle:Visibility\AccountCategoryVisibility');
    ...
    protected function getVisibilityResolved()
    {
        $em = $this->registry
            ->getManagerForClass('OroCustomerBundle:VisibilityResolved\AccountCategoryVisibilityResolved');
        $qb = $em->getRepository('OroCustomerBundle:VisibilityResolved\AccountCategoryVisibilityResolved')
    ...
    {
        return $this->registry->getManagerForClass('OroCustomerBundle:Visibility\AccountCategoryVisibility')
