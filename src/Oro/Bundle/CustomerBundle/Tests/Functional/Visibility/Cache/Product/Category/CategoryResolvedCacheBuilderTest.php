...
class CategoryResolvedCacheBuilderTest extends AbstractProductResolvedCacheBuilderTest
{
    ...
    public function testChangeCategoryVisibilityToHidden()
    {
        ...
        $em = $this->registry->getManagerForClass('OroCustomerBundle:Visibility\CategoryVisibility');
    ...
    {
        $em = $this->registry->getManagerForClass('OroCustomerBundle:VisibilityResolved\CategoryVisibilityResolved');
        $qb = $em->getRepository('OroCustomerBundle:VisibilityResolved\CategoryVisibilityResolved')
    ...
    {
        return $this->registry->getManagerForClass('OroCustomerBundle:Visibility\CategoryVisibility')
