...
namespace Oro\Bundle\CustomerBundle\Tests\Functional\Visibility\Cache;
...
class ProductResolvedCacheBuilderBuildCacheTest extends WebTestCase
{
    ...
    public function testBuildCache()
    {
        ...
        $repository->createQueryBuilder('entity')
            ->delete('OroCustomerBundle:VisibilityResolved\ProductVisibilityResolved', 'entity')
            ->getQuery()
            ->execute();
    ...
    {
        return $this->getManager()->getRepository('OroCustomerBundle:VisibilityResolved\ProductVisibilityResolved');
    }
