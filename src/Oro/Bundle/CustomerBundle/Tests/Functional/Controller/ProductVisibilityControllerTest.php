...
class ProductVisibilityControllerTest extends WebTestCase
{
    ...
    const PRODUCT_VISIBILITY_CLASS = 'OroCustomerBundle:Visibility\ProductVisibility';
    const ACCOUNT_PRODUCT_VISIBILITY_CLASS = 'OroCustomerBundle:Visibility\AccountProductVisibility';
    const ACCOUNT_GROUP_PRODUCT_VISIBILITY_CLASS = 'OroCustomerBundle:Visibility\AccountGroupProductVisibility';
