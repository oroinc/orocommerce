...
class WorkflowPermissionDatasourceTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function validateResult($result)
    {
        ...
        $this->assertEquals('commerce_role_prefix.GLOBAL_trans', $permission1['access_level_label']);
        ...
        $this->assertEquals('commerce_role_prefix.DEEP_trans', $permission2['access_level_label']);
        ...
        $this->assertEquals('commerce_role_prefix.DEEP_trans', $permission1['access_level_label']);
        ...
        $this->assertEquals('commerce_role_prefix.BASIC_trans', $permission1['access_level_label']);
    }
}
