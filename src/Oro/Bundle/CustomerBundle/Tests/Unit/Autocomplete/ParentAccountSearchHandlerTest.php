...
use Oro\Bundle\CustomerBundle\Autocomplete\ParentAccountSearchHandler;
...
class ParentAccountSearchHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var ParentAccountSearchHandler
     */
    ...
    protected function setUp()
    {
        $this->entityRepository = $this
            ->getMockBuilder('Oro\Bundle\CustomerBundle\Entity\Repository\AccountRepository')
        ...
        $this->searchHandler = new ParentAccountSearchHandler(self::TEST_ENTITY_CLASS, ['name']);
