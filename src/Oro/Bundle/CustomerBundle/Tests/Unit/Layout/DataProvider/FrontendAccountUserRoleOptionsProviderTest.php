...
use Oro\Bundle\CustomerBundle\Layout\DataProvider\FrontendAccountUserRoleOptionsProvider;
...
class FrontendAccountUserRoleOptionsProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->role = $this->getEntity('Oro\Bundle\CustomerBundle\Entity\AccountUserRole');
    }
