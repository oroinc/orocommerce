...
use Oro\Bundle\CustomerBundle\Layout\DataProvider\FrontendCustomerUserRoleOptionsProvider;

class FrontendCustomerUserRoleOptionsProviderTest extends \PHPUnit_Framework_TestCase
{
    use EntityTrait;
    ...
    /** @var FrontendCustomerUserRoleOptionsProvider */
    protected $provider;
    ...
    protected function setUp()
    {
        ...
        $this->provider = new FrontendCustomerUserRoleOptionsProvider(
            $this->capabilityProvider,
            $this->categoryProvider,
            $this->translator
        );

        $this->role = $this->getEntity('Oro\Bundle\CustomerBundle\Entity\CustomerUserRole');
    }
