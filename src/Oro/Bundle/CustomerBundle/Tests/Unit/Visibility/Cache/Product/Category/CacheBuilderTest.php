...
namespace Oro\Bundle\CustomerBundle\Tests\Unit\Visibility\Cache\Product\Category;

use Oro\Bundle\CustomerBundle\Tests\Unit\Visibility\Cache\Product\AbstractCacheBuilderTest;
...
class CacheBuilderTest extends AbstractCacheBuilderTest
{
    ...
    public function testAddBuilder()
    {
        ...
        $customBuilder
            = $this->getMock('Oro\Bundle\CustomerBundle\Visibility\Cache\CategoryCaseCacheBuilderInterface');
