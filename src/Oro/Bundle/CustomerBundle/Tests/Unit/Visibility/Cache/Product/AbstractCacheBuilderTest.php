...
namespace Oro\Bundle\CustomerBundle\Tests\Unit\Visibility\Cache\Product;

use Oro\Bundle\CustomerBundle\Visibility\Cache\CacheBuilderInterface;
use Oro\Bundle\CustomerBundle\Visibility\Cache\Product\CacheBuilder as ProductCaseCacheBuilder;
use Oro\Bundle\CustomerBundle\Visibility\Cache\Product\Category\CacheBuilder as CategoryCaseCacheBuilder;
...
abstract class AbstractCacheBuilderTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @var string
     */
    protected $cacheBuilderInterface = 'Oro\Bundle\CustomerBundle\Visibility\Cache\CacheBuilderInterface';
    ...
    {
        $mock = $this->getMock('Oro\Bundle\CustomerBundle\Entity\Visibility\VisibilityInterface');
    ...
    public function testIsVisibilitySettingsSupportedFalse()
    {
        $result = $this->assertCallAllBuilders(
            ...
            $this->getMock('Oro\Bundle\CustomerBundle\Entity\Visibility\VisibilityInterface')
        );
