...
{
    const VISIBILITY_CLASS = 'Oro\Bundle\CustomerBundle\Entity\Visibility\CategoryVisibility';
    ...
    public function testGetFormattedChoices()
    {
        ...
        $expected = [
            'parent_category' => '[trans]oro.customer.visibility.categoryvisibility.choice.parent_category[/trans]',
            'config' => '[trans]oro.customer.visibility.categoryvisibility.choice.config[/trans]',
            'hidden' => '[trans]oro.customer.visibility.categoryvisibility.choice.hidden[/trans]',
            'visible' => '[trans]oro.customer.visibility.categoryvisibility.choice.visible[/trans]',
        ];
