...
class VisibilityMessageFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function createMessageDataProvider()
    {
        return [
            'productVisibility' => [
                'className' => 'Oro\Bundle\CustomerBundle\Entity\Visibility\ProductVisibility',
                'id' => 42,
                'expected' => [
            ...
            'accountProductVisibility' => [
                'className' => 'Oro\Bundle\CustomerBundle\Entity\Visibility\AccountProductVisibility',
                'id' => 123,
                'expected' => [
            ...
            'accountGroupProductVisibility' => [
                'className' => 'Oro\Bundle\CustomerBundle\Entity\Visibility\AccountGroupProductVisibility',
                'id' => 321,
                'expected' => [
