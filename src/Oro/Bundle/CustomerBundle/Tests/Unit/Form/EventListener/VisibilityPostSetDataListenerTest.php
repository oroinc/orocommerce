...
class PostSetDataVisibilityListenerTest extends AbstractVisibilityListenerTestCase
{
    ...
    {
        $categoryVisibility = $this->getMockBuilder('Oro\Bundle\CustomerBundle\Entity\Visibility\CategoryVisibility')
    ...
    protected function getAccountCategoryVisibility()
    {
        ...
        $this->account = $this->getMock('Oro\Bundle\CustomerBundle\Entity\Account');
        $this->account->expects($this->once())
            ->method('getId')
            ->willReturn(1);

        $visibility = $this->getMockBuilder('Oro\Bundle\CustomerBundle\Entity\Visibility\AccountCategoryVisibility')
    ...
    protected function getAccountGroupCategoryVisibility()
    {
        ...
        $this->accountGroup = $this->getMock('Oro\Bundle\CustomerBundle\Entity\AccountGroup');
