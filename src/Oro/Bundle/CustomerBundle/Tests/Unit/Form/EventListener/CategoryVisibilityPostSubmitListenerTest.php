...
use Oro\Bundle\CustomerBundle\Form\EventListener\CategoryVisibilityPostSubmitListener;
...
class CategoryPostSubmitVisibilityListenerTest extends AbstractVisibilityListenerTestCase
{
    ...
    protected function getEventMock()
    {
        ...
        $visibilityForAccountFormMock = $this
            ->getCommonVisibilityFormMock(
                'Oro\Bundle\CustomerBundle\Entity\Visibility\AccountCategoryVisibility',
    ...
    protected function prepareCategoryVisibilityRepository(
        ...
        $categoryVisibility = $this
            ->getMockBuilder('Oro\Bundle\CustomerBundle\Entity\Visibility\CategoryVisibility')
        ...
        $accountCategoryVisibilities = new ArrayCollection(
            [
                $this->getAccountCategoryVisibilityMock(
                    ...
                    $this->getEntity('Oro\Bundle\CustomerBundle\Entity\Account', 1)
                ),
                $this->getAccountCategoryVisibilityMock(
                    AccountCategoryVisibility::PARENT_CATEGORY,
                    $this->getEntity('Oro\Bundle\CustomerBundle\Entity\Account', 2)
                ),
                $this->getAccountCategoryVisibilityMock(
                    AccountCategoryVisibility::VISIBLE,
                    $this->getEntity('Oro\Bundle\CustomerBundle\Entity\Account', 3)
                ),
            ]
        );
        ...
        $accountGroupCategoryVisibilities = new ArrayCollection(
            [
                $this->getAccountGroupCategoryVisibilityMock(
                    ...
                    $this->getEntity('Oro\Bundle\CustomerBundle\Entity\AccountGroup', 1)
                ),
                $this->getAccountGroupCategoryVisibilityMock(
                    AccountGroupCategoryVisibility::PARENT_CATEGORY,
                    $this->getEntity('Oro\Bundle\CustomerBundle\Entity\AccountGroup', 2)
                ),
                $this->getAccountGroupCategoryVisibilityMock(
                    AccountGroupCategoryVisibility::VISIBLE,
                    $this->getEntity('Oro\Bundle\CustomerBundle\Entity\AccountGroup', 3)
                ),
            ]
        );
    ...
    {
        $category = $this->getEntity('Oro\Bundle\CatalogBundle\Entity\Category', self::CATEGORY_ID);
        $account = $this->getEntity('Oro\Bundle\CustomerBundle\Entity\Account', 1);
        $data = [
            [
                'entity' => $account,
                'data' => [
    ...
    {
        $category = $this->getEntity('Oro\Bundle\CatalogBundle\Entity\Category', self::CATEGORY_ID);
        $accountGroup = $this->getEntity('Oro\Bundle\CustomerBundle\Entity\AccountGroup', 1);
        $data = [
            [
                'entity' => $accountGroup,
                'data' => [
    ...
    protected function getAccountCategoryVisibilityMock($visibility, $account)
    {
        $visibilityEntity = $this
            ->getMockBuilder('Oro\Bundle\CustomerBundle\Entity\Visibility\AccountCategoryVisibility')
    ...
    {
        $visibilityEntity = $this
            ->getMockBuilder('Oro\Bundle\CustomerBundle\Entity\Visibility\AccountGroupCategoryVisibility')
