...
class FrontendCustomerUserTypedAddressTypeTest extends CustomerTypedAddressTypeTest
{
    ...
    public function submitWithFormSubscribersProvider()
    {
        ...
        $customerUser->addAddress($customerAddress1);
        $customerUser->addAddress($customerAddress2);
