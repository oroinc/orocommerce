...
use Oro\Bundle\CustomerBundle\Entity\Visibility\Repository\CategoryVisibilityRepository;
...
use Oro\Bundle\CustomerBundle\Entity\VisibilityResolved\Repository\CategoryRepository;
...
use Oro\Bundle\CustomerBundle\Visibility\Cache\Product\AbstractResolvedCacheBuilder;
...
class CategoryResolvedCacheBuilder extends AbstractResolvedCacheBuilder implements CategoryCaseCacheBuilderInterface
{
    ...
    public function buildCache(Website $website = null)
    {
        ...
        $repository = $this->registry->getManagerForClass('OroCustomerBundle:Visibility\CategoryVisibility')
