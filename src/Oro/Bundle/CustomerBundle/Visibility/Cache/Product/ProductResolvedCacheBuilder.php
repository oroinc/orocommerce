    ...
    ProductCaseCacheBuilderInterface
{
    ...
    public function resolveVisibilitySettings(VisibilityInterface $visibilitySettings)
    {
        ...
        $em = $this->registry->getManagerForClass('OroCustomerBundle:VisibilityResolved\ProductVisibilityResolved');
        $er = $em->getRepository('OroCustomerBundle:VisibilityResolved\ProductVisibilityResolved');
    ...
    public function productCategoryChanged(Product $product)
    {
        ...
        if ($category) {
            ...
            $this->registry->getManagerForClass('OroCustomerBundle:Visibility\ProductVisibility')
