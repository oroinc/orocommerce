    ...
    ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $filePath = $locator->locate('@OroCustomerBundle/Migrations/Data/Demo/ORM/data/categories-visibility.csv');
        ...
        fclose($handler);
        $manager->flush();
        $this->container->get('oro_customer.visibility.cache.product.category.cache_builder')->buildCache();
    }
    ...
    {
        return $manager->getRepository('OroCustomerBundle:Account')->findOneBy(['name' => $name]);
    }
    ...
    {
        return $manager->getRepository('OroCustomerBundle:AccountGroup')->findOneBy(['name' => $name]);
    }
