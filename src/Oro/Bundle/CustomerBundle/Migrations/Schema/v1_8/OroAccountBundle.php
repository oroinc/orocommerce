...
//            $this->updateOldAttachments($schema, $queries);
//            $this->updateOldNotes($schema, $queries);
//        }
//
    ...
    private function renameOldActivityTables(Schema $schema, QueryBag $queries)
    {
        ...
        // email to account user association
//        $extension->renameTable($schema, $queries, 'oro_rel_26535370a6adb604a9b8e1', 'oro_rel_26535370a6adb604264ef1');
        $queries->addQuery(new UpdateExtendRelationQuery(
            'Oro\Bundle\EmailBundle\Entity\Email',
            'Oro\Bundle\CustomerBundle\Entity\AccountUser',
        ...
        // calendar event to account user association
//        $extension->renameTable($schema, $queries, 'oro_rel_46a29d19a6adb604a9b8e1', 'oro_rel_46a29d19a6adb604264ef1');
        $queries->addQuery(new UpdateExtendRelationQuery(
            'Oro\Bundle\CalendarBundle\Entity\CalendarEvent',
            'Oro\Bundle\CustomerBundle\Entity\AccountUser',
            'account_user_489123cf',
...
//     * @param QueryBag $queries
//     */
//    private function updateOldAttachments(Schema $schema, QueryBag $queries)
//    {
//        $extension = $this->renameExtension;
//        $attachments = $schema->getTable('oro_attachment');
//
...
//     * @param QueryBag $queries
//     */
//    private function updateOldNotes(Schema $schema, QueryBag $queries)
//    {
//        $extension = $this->renameExtension;
//        $notes = $schema->getTable('oro_note');
//
