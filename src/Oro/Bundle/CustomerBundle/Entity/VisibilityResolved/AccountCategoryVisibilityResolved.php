...
/**
 * @ORM\Entity(
 *    repositoryClass="Oro\Bundle\CustomerBundle\Entity\VisibilityResolved\Repository\AccountCategoryRepository"
 * )
...
class AccountCategoryVisibilityResolved extends BaseCategoryVisibilityResolved
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Oro\Bundle\CustomerBundle\Entity\Visibility\AccountCategoryVisibility")
