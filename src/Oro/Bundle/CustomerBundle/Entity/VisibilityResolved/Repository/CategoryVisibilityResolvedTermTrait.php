...
trait CategoryVisibilityResolvedTermTrait
{
    ...
    protected function getAccountGroupCategoryVisibilityResolvedTerm(
        ...
        $qb->leftJoin(
            'Oro\Bundle\CustomerBundle\Entity\VisibilityResolved\AccountGroupCategoryVisibilityResolved',
            'agcvr',
            Join::WITH,
            $qb->expr()->andX(
    ...
    {
        $qb->leftJoin(
            'Oro\Bundle\CustomerBundle\Entity\VisibilityResolved\AccountCategoryVisibilityResolved',
            'acvr',
            Join::WITH,
            $qb->expr()->andX(
