...
class CategoryRepository extends EntityRepository
{
    ...
    public function getCategoryIdsByNotResolvedVisibility($visibility)
    {
        ...
        $qb->select('category.id')
            ->from('OroCatalogBundle:Category', 'category')
            ->leftJoin(
                'Oro\Bundle\CustomerBundle\Entity\VisibilityResolved\CategoryVisibilityResolved',
                'cvr',
                Join::WITH,
    ...
    public function insertStaticValues(InsertFromSelectQueryExecutor $insertExecutor)
    {
        ...
        $queryBuilder = $this->getEntityManager()->createQueryBuilder()
            ...
            ->from('OroCustomerBundle:Visibility\CategoryVisibility', 'cv')
    ...
    public function insertParentCategoryValues(
        ...
        $queryBuilder = $this->getEntityManager()->createQueryBuilder()
            ...
            ->leftJoin('OroCustomerBundle:Visibility\CategoryVisibility', 'cv', 'WITH', 'cv.category = c')
