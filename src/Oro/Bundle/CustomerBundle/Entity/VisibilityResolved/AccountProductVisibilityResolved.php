...
/**
 * @ORM\Entity(
 *    repositoryClass="Oro\Bundle\CustomerBundle\Entity\VisibilityResolved\Repository\AccountProductRepository"
 * )
...
class AccountProductVisibilityResolved extends BaseProductVisibilityResolved
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Oro\Bundle\CustomerBundle\Entity\Visibility\AccountProductVisibility")
