...
/**
 * @ORM\Entity(
 *    repositoryClass="Oro\Bundle\CustomerBundle\Entity\VisibilityResolved\Repository\AccountGroupCategoryRepository"
 * )
...
class AccountGroupCategoryVisibilityResolved extends BaseCategoryVisibilityResolved
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Oro\Bundle\CustomerBundle\Entity\Visibility\AccountGroupCategoryVisibility")
