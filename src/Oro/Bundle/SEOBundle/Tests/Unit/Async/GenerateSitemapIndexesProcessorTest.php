...
use Oro\Bundle\SEOBundle\Async\GenerateSitemapIndexesProcessor;
...
class GenerateSitemapIndexesProcessorTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var GenerateSitemapIndexesProcessor */
    private $processor;
    ...
    protected function setUp(): void
    {
        ...
        $this->processor = new GenerateSitemapIndexesProcessor(
            $this->jobRunner,
            $this->dependentJob,
            $this->producer,
            $this->logger
    ...
    public function testGetSubscribedTopics()
    {
        self::assertEquals(
            ...
            GenerateSitemapIndexesProcessor::getSubscribedTopics()
        );
    }
    ...
    public function testProcessWhenSendChildMessagesFailed()
    {
        ...
        $this->dependentJob->expects(self::once())
            ...
            ->willReturn(new DependentJobContext($job->getRootJob()));
