...
Feature: Product import with meta information
  ...
  Scenario: Import products
    ...
    And I should see "Error in row #1. metaTitles[English].fallback: The value you selected is not a valid choice."
    And I should see "Error in row #1. metaDescriptions[default].fallback: The value you selected is not a valid choice."
    And I should see "Error in row #1. metaDescriptions[English].fallback: The value you selected is not a valid choice."
    And I should see "Error in row #1. metaKeywords[default].fallback: The value you selected is not a valid choice."
    And I should see "Error in row #1. metaKeywords[English].fallback: The value you selected is not a valid choice."
  ...
  Scenario: Check imported products
    ...
    And Exported file for "Products" with processor "oro_product_product" contains at least the following columns:
      | sku   | attributeFamily.code | status  | type   | inventory_status.id | primaryUnitPrecision.unit.code | primaryUnitPrecision.precision | primaryUnitPrecision.conversionRate | primaryUnitPrecision.sell | names.default.fallback | names.default.value | names.English.fallback | names.English.value | shortDescriptions.default.fallback | shortDescriptions.default.value | shortDescriptions.English.fallback | shortDescriptions.English.value | descriptions.default.fallback | descriptions.default.value | descriptions.English.fallback | descriptions.English.value | variantFields | availability_date | featured | newArrival | backOrder.value | category.id | decrementQuantity.value | highlightLowInventory.value | inventoryThreshold.value | lowInventoryThreshold.value | manageInventory.value | maximumQuantityToOrder.value | metaDescriptions.default.fallback | metaDescriptions.default.value | metaDescriptions.English.fallback | metaDescriptions.English.value | metaKeywords.default.fallback | metaKeywords.default.value | metaKeywords.English.fallback | metaKeywords.English.value | metaTitles.default.fallback | metaTitles.default.value | metaTitles.English.fallback | metaTitles.English.value | minimumQuantityToOrder.value | isUpcoming.value | slugPrototypes.default.fallback | slugPrototypes.default.value | slugPrototypes.English.fallback | slugPrototypes.English.value | category.default.title |
