 ...
 */
class GenerateSitemapIndexesProcessor implements MessageProcessorInterface, TopicSubscriberInterface
{
     ...
     */
    private function createFinishJob(Job $job, int $version, array $websiteIds)
    {
     ...
     */
    private function scheduleGeneratingSitemapIndex(JobRunner $jobRunner, int $version, array $websiteIds)
    {
