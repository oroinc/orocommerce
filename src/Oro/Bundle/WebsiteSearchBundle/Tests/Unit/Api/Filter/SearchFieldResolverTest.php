...
class SearchFieldResolverTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->fieldResolver = new SearchFieldResolver(
            [
                ...
                'field3' => ['type' => null],
                'field4' => [],
                'field5_enum.ENUM_ID' => ['type' => 'string'],
    ...
    public function testResolveFieldNameForEnumField(): void
    {
        self::assertEquals(
            'field5_enum.ENUM_ID',
            $this->fieldResolver->resolveFieldName('field5')
        );
    }

    public function testResolveFieldTypeForEnumField(): void
    {
        self::assertEquals(
            'string',
            $this->fieldResolver->resolveFieldType('field5')
        );
    }
