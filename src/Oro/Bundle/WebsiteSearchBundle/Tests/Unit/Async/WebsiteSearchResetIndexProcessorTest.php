...
class WebsiteSearchResetIndexProcessorTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->processor = new WebsiteSearchResetIndexProcessor($this->indexer, $this->eventDispatcher);
    ...
    {
        self::assertEquals([WebsiteSearchResetIndexTopic::getName()], $this->processor::getSubscribedTopics());
    }
