...
class WebsiteSearchSaveProcessorTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->processor = new WebsiteSearchSaveProcessor($this->indexer, $this->eventDispatcher);
    ...
    {
        self::assertEquals([WebsiteSearchSaveTopic::getName()], $this->processor::getSubscribedTopics());
    }
