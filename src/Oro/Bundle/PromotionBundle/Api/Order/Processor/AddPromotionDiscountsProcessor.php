...
namespace Oro\Bundle\PromotionBundle\Api\Order\Processor;
...
class AddPromotionDiscountsProcessor implements ProcessorInterface
{
    /**
    ...
    {
        if (!$context instanceof CustomizeLoadedDataContext) {
            return;
        }
