...
namespace Oro\Bundle\PromotionBundle\Tests\Unit\Api\Order\Processor;
...
use Oro\Bundle\PromotionBundle\Api\Order\Processor\AddPromotionDiscountsProcessor;
use Oro\Bundle\PromotionBundle\Provider\AppliedDiscountsProvider;
use Oro\Component\ChainProcessor\ContextInterface;
use PHPUnit\Framework\TestCase;

class AddPromotionDiscountsProcessorTest extends TestCase
{
    /**
    ...
    /**
     * @var AddPromotionDiscountsProcessor
     */
    private $processor;
    ...
    protected function setUp()
    {
        ...
        $this->processor = new AddPromotionDiscountsProcessor(
