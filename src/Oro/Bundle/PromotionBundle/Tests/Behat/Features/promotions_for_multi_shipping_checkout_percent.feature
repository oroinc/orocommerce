...
@fixture-OroPromotionBundle:promotions-multishipping-shipping-discounts-percent.yml

Feature: Promotions for multi shipping checkout percent
  In order to use discounts
  As a Buyer
  I need discounts to be applied to a multi shipping order (with percent shipping discount)
  ...
  Scenario: Check discounts in created order and sub orders on order history page.
    ...
    And I should see "Shipping Discount -$3.00" in the "Subtotals" element
    And I should see "Tax $0.00" in the "Subtotals" element
    And I should see "Total $51.00" in the "Subtotals" element
