...
use Oro\Component\Duplicator\Tests\Unit\Stub\ProductUnit;
use Oro\Component\Duplicator\Tests\Unit\Stub\RequestProduct;
use Oro\Component\Duplicator\Tests\Unit\Stub\RequestProductItem;
use Oro\Component\Duplicator\Tests\Unit\Stub\RFPRequest;
use Oro\Component\Duplicator\Tests\Unit\Stub\Status;
...
class DuplicatorTest extends \PHPUnit_Framework_TestCase
{
    public function testDuplicate()
    {
        ...
        $params = [
            ...
            [['replaceValue', $now], ['property', [RFPRequest::class, 'createdAt']]],
            [['setNull'], ['property', [RequestProduct::class, 'id']]],
            [['shallowCopy'], ['property', [RequestProductItem::class, 'unit']]],
        ];
